...
var cnRegReplace = new Map([
    ...
    [/^(\d+) mo (\d+) days (\d+) hr (\d+) min (\d+) sec$/, '$1 月 $2 天 $3 小时 $4 分钟 $5 秒'],
    ...
    [/^Your (\d+) minutes (\d+)x global speed multiplier has been saved. It can be activated under the Reward History tab.$/, '您的$1分钟$2倍全局速度倍增器已保存。它可以在奖励历史选项卡下激活。'],
