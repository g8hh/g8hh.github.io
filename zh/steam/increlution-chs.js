...
var cnItems = {
    ...
    "level up slower, but persist through death, so they'll improve how well you'll perform at actions that use that skill in all following lives. The combination of these levels determines the speed at which you can perform actions that use this skill, as well as affect the experience per second for both.": "升级速度较慢，但会在死亡中坚持下去，因此它们会提高您在接下来的所有生活中使用该技能的动作的表现。这些级别的组合决定了您可以使用此技能执行操作的速度，并影响两者的每秒经验。",
    "License": "执照",
    ...
    "Meet the mayor": "认识市长",
    "Paddle forth": "向前划桨",
    "Paddle in temple": "在寺里划桨",
    "Paddle upstream": "逆流而上",
    "Pan of soup": "煲汤",
    "Parrot teaching": "鹦鹉之力",
    "Pass narrow path": "通过狭窄的小路",
    "Pass spike trap": "踏过尖刺陷阱",
    "Pass waterfall": "划过瀑布",
    "Pick apples": "摘苹果",
    "Pick banana": "摘香蕉",
    "Pick orange": "摘橙子",
    "Pick tomato": "摘番茄",
    "Proceed in mine": "深入矿井",
    "Pull in gemstone": "钓起宝石",
    "Raft": "木筏",
    "Raft sail": "风帆",
    "Reinforced belt": "铁腰带",
    ...
    "Walk around": "走下去",
    "Walk to oasis": "走到绿洲",
    "Walk to pyramid": "走到金字塔",
    "Walk to village": "走到村庄",
    "Woodcutting ×": "伐木 ×",
    "Wooden bow": "木弓",
    "Wooden cart": "木制推车",
    "Abandoned camp": "废弃营地",
    ...
    "Descend layer": "下一层",
    "Different how?": "怎么不一样？",
    "Dig through snow": "挖穿积雪",
    "Dock aside ships": "停在船旁",
    "Dock at beach": "停在海滩",
    "Dock at harbor": "停在码头",
    "Dock on shore": "停在岸边",
    "Dragon ride": "骑龙",
    "Dragon's equals": "与龙相当的人",
    "Enter cell": "进入监狱",
    "Enter city": "进入城市",
    "Enter jungle": "进入丛林",
    "Enter lowtown": "进入市镇",
    "Enter market": "进入市场",
    "Enter old mine": "进入旧矿山",
    ...
    "Follow stream": "顺流而下",
    "Follow the sounds": "跟着声音",
    "Friendly chat": "友好聊天",
    "Fruit vendor": "水果小贩",
    "Funnel hourglass": "注入沙漏",
    "Funnel shield": "注入盾牌",
    "Funnel tooth": "注入龙牙",
    "Get escorted out": "护送出去",
    "Get ransacked": "被洗劫一空",
    "Go to dining area": "前往食堂",
    "Go to hightown": "去内城",
    "Go to yard": "去院子",
    "Help digging": "帮助越狱",
    "Herring": "鲱鱼",
    ...
    "Path around lava": "熔岩小路",
    "Persuade guard": "说服警卫",
    "Pick a fight": "选择战斗",
    "Pie": "馅饼",
    "Pie vendor": "馅饼供应商",
    "Play cards": "打牌",
    "Proceed in alley": "在小巷里前进",
    "Raft racing": "木筏比赛",
    "Read inscriptions": "阅读铭文",
    "Reject shield": "拒绝盾牌",
    "Return for finale": "决战",
    "Return to arena": "重返赛场",
    "Return to cell": "返回监狱",
    "Return to diner": "返回食堂",
    "Return to the kids": "回到孩子们身边",
    "Ride minecart": "乘坐矿车",
    "Sabotage camp": "破坏营地",
    "Sail east": "向东航行",
    "Sail north": "向北航行",
    "Sail through ice": "航过冰原",
    "Sail to smoke": "航行到烟雾中去",
    "Sail to volcano": "航行到火山",
    "Sail west": "向西航行",
    "Scavenger hunt": "寻宝游戏",
    "See sarcophagus": "观察石棺",
    "Set sail": "启航",
    "Short break": "中场休息",
    "Sneak past": "偷摸过去",
    "So what now?": "现在该怎么办？",
    ...
    "Tomato vendor": "番茄商人",
    "Tools vendor": "工具商",
    "Walk frozen lake": "走过冰面",
    "Walk inland": "在内陆走",
    "Walk to docks": "走到码头",
    "Walk to eatery": "步行去食堂",
    "Walk to gate": "走到门口",
    "Walk to quarry": "前往采石场",
    "Walk to temple": "走到寺庙",
    "Weed out nettles": "剪净荨麻",
    "Work on tunnel": "越狱通道",
    "Your part in this": "你的贡献",
    ...
    "This increase is compounding, so it increases 0.50 > 0.63 > 0.79 > 0.98 > 1.23 during the first four minutes (actual values can be affected by constructions": "这种增加是复利的，因此在前四分钟内增加了 0.50 > 0.63 > 0.79 > 0.98 > 1.23（实际值可能会受到结构的影响",
    ...
    "inventory capacity by 10": "库存容量增加 10",
    "Requirement": "要求",
    "Agility": "敏捷",
    "Agility skill": "敏捷技能",
    "Build time": "构建时间",
    ...
    "There are just some bushes and trees around, but perhaps there are more interesting things nearby": "眼前只有一些灌木丛和树，但附近也许还有更多有趣的东西",
    "Up to +1 health per second": "每秒最多 +1 生命值",
    "Woodcutting skill  | ": "伐木技能 | ",
    "Agility skill  | ": "敏捷技能 | ",
    "Campfire, you are out of Wood": "营火，你不在树林里了",
    "Spider, removed. Well done! The path to the other side of the cave appears to be clear now. However, it seems like there aren't any berries on the other side. It does look like there are some kind of trees though": "蜘蛛，解决。 做得好！ 通往洞穴另一边的路径很清晰。 不过，另一边似乎没有任何浆果。但是看起来确实有某种树",
    ...
    "Determines which priorities your automations default to when you first unlock them": "决定您的自动化在首次解锁时默认的优先级",
    ...
    "Determines how numbers above 1000 are displayed. If you're not familiar with number notations, the standard notation is advised. Other notations are optional for those that prefer them. After changing notations, some numbers aren't updated ": "决定如何显示大于 1000 的数字。如果您不熟悉数字符号，建议使用标准符号。对于喜欢它们的人来说，其他符号是可选的。更改符号后，某些数字未更新",
    "until their actual value changes. Restarting the game forces them to reload as well": "直到它们的实际值发生变化。重新启动游戏也会迫使他们重新加载",
    "Determines how time differences are displayed for story completions": "决定如何显示故事完成的时间差异",
    "Determines how time is displayed for story completions": "决定故事完成时间的显示方式",
    "Determines which colors are used for the UI theme": "决定用于 UI 主题的颜色",
    ...
    "Making it to the other side of the lake felt easy with this bridge! There also seem to be rabbits on this side of the lake, you can probably hunt some. However, it seems that there is also a wolf on this side of the lake. You know what needs to be done": "有了这座浮桥，就可以轻松到达湖的另一边！ 湖这边好像也有兔子，大概可以猎捕一些。 不过，似乎也有一只狼。 你知道该做什么",
    "All aboard and ready to set sail! This is going to be a tough ride, especially since you can't reach most of the resources now. Let's hope your preparations will suffice!": "一切就绪，准备启航！这将是一段艰难的旅程，尤其是因为您将无法获得大部分食物。让我们希望你的准备充足！",
    "Hunting": "打猎",
    "It seems that there is an island on the other side of the water! But it's definitely too far for a bridge to cover. Perhaps some floating object could help here?": "好像水的另一边有一座小岛！但对于一座浮桥来说，这绝对是太远了。也许筏子可以在这里提供帮助？",
    ...
    "Sailing": "航行",
    "So much for that wolf. You're getting pretty good at this! Now that you're able to see a bit further, it appears that there is a shore nearby": "无需多言那只狼。你在这方面做得很好！现在你可以看得更远，附近似乎有一个海岸",
    "Social": "社交",
    "Thanks to the fisher, you now know how to catch herring! Delicious for raw consumption! Especially with pickles and onions, but just raw will do": "感谢渔夫，您现在知道如何捕捉鲱鱼了！可口的食物！尤其是泡菜和洋葱一起，但生鲱鱼也不赖",
    "The farmer seems fond of you, and says that you can gather grain whenever you want! As long you don't hurt the chickens, which seems fair": "农夫似乎很喜欢你，并说你可以随时纳粮！只要你不伤害鸡，这似乎很公平",
    "The miner was very open to you and allows you to use the mine whenever you want! It contains stone like you're quite used to. But also some copper that seems a bit trickier to dig. That might just be useful for other forms of construction!": "矿工对您非常包容，允许您随时使用矿井！里面不仅有着你习于挖掘的石头。但也有一些似乎有点难以挖掘的铜。这可能对别的制作有用！",
    ...
    "You've made it to the village. It appears to be quite a cozy little town, there are quite a few people living here. Let's get to know them!": "你已经到了村子。这看起来是个很温馨的小镇，住在这里的人也不少。让我们了解他们！",
	...
	"Ok, after a lot of running, climbing and bruises, you've made it up onto a rock where the bear can't seem to climb. Luckily for you, it appears that there's an exit if you crawl past these stones!": "好吧，经过大量的奔跑、攀爬和擦伤，你已经爬上了一块熊似乎爬不上去的岩石。 幸运的是，如果你爬过这些石头，似乎有一个出口！",
    ...
    "Pfeew, those people sure knew how to dance. But, not as well as you do! Have five silver coins for your efforts!": "呼，那些人肯定会跳舞。但是，没有你做的那么好！有五个银币为你的努力！",
    ...
    "That settles it. You're the coolest person in this tavern! No hard feelings, just a lot of respect! And ten silver coins for your troubles": "这就解决了。你是这个酒馆里最酷的人！获得了很多尊重，但内心毫无波动！还有十个银币来解决你的烦恼",
    ...
    "\"I know, you don't remember me. But you've been here before.\" She proceeds to tell you: \"I go by Amy these days. I came here to end the cycle. But now that you're here, I think I understand why it didn't work.": "“我知道，你不记得我了。但你以前来过这里。”她继续告诉你：“这些天我都叫艾米。我来这里是为了结束这个循环。但现在你在这里，我想我明白为什么它不起作用了。",
    ...
    "Back on shore, finally! Well, a muddy bank covered in snow anyway. It looks like there's a bunch of seals living around here, and you see falcons again!": "终于回到岸上！好吧，无论如何，一个被雪覆盖的泥质河岸。看起来这里有一群海豹，你又看到了猎鹰！",
    "Can be cooked": "可以烹饪",
    "Combat shield": "战斗盾牌",
    "Determines how often you can eat every food-type": "决定您吃每种食物的频率",
    "Determines the damage taken in": "决定受到的伤害",
    "Discovery": "发现",
    "Food cooldown": "食物冷却",
    "Food health": "食物生命值",
    "health decay has quadrupled": "生命值衰退翻了4倍",
    ...
    "Now that you've dug through the biggest pile of snow, you've arrived at what seems to be a lake. A frozen one. You don't really see any way around it. Using this exit must have originally involved boats in warmer days": "现在你已经挖过最大的雪堆，你已经到达了一个看起来像湖的地方。一个冻结的。你真的看不到任何解决办法。使用这个出口必须在温暖的日子里有原本涉及船只",
    "Oof, let's call it refreshing... the ice did not hold. However, from this point forth you should be able to climb on your raft to continue!": "哦，让我们称之为清爽......冰没有保持。但是，从这一点开始，您应该能够爬上您的木筏继续前进！",
    ...
    "Pfeew, that was a little scary, but you've managed to cross the lava flow. Now that you've made it to the volcano, you should be able to bypass further lava coming down as the eruption has stopped": "呼，这有点吓人，但你已经设法穿过熔岩流。现在你已经到达火山了，你应该能够绕过更多的熔岩，因为喷发已经停止",
    "Shield claimed. Now that you're able to protect yourself a bit better in battle, you feel slightly more comfortable heading into the next fight": "得到盾牌。既然你能够在战斗中更好地保护自己，那么进入下一场战斗你会感觉更舒服一些",
    ...
    "You've made it to the other side of the ravine! The fast way, although it hurt a bit. You see a temple a little higher up in the mountain and hear some gong sounds in the distance": "你已经到了峡谷的另一边！最快的方式，就是有点疼。你在山上看到一座寺庙，在远处听到一些锣声",
    ...
    "Walking into the treasure room, you can barely see all of it. It's that big. The treasures themselves seem to be long gone, probably pillaged over the years. Although there are some ancient writings near what looks to have been a throne at one point": "走进宝藏室，几乎看不到全貌。 它那么大。 宝物本身似乎早已不复存在，可能多年来被掠夺。 尽管在某个看起来曾经是宝座的地方附近有一些古代著作",
    "The treasury has definitely seen better days. There's a lot of empty space, huge pillars and only some statues and inscriptions left. That throne that you spotted when you initially entered the treasury seems to be guarded by some sort of machine made from stone": "宝库肯定曾有更好的日子。 空地很多，巨大的柱子，只剩下一些雕像和铭文。 刚进入宝库时看到的那个宝座，似乎被某种石制机器守护着",
    ...
    "It seems that": "看起来",
    "Learn more about who Amy met": "详细了解艾米遇到的人",
    ...
    "Would you look at that! There's some corn still standing! It's definitely not in the best condition, and appears to be deteriorating rapidly. But it looks like you should still be able to gather some edible ears!": "你会看那个吗！还有一些玉米还在！它绝对不是最佳状态，而且似乎正在迅速恶化。但看起来你应该还能收集一些可食用的玉米棒子！",
    ...
    "Passing through this smoke triples your": "穿过这烟雾会三倍你的",
    ...
    "Provides a full inventory of bull meat upon completion, which can be cooked": "完成后提供完整的公牛肉库存，可以烹饪",
    ...
    "The heat within the volcano quadruples your": "火山内的热量会四倍你的",
    ...
    "gain after life, but causes you to lose your resources and triples your": "转生时获得，但会导致您失去资源并使您的资源增加三倍",
    "High": "高的",
    ...
    "This beast is fast, but you've managed to hold on so far! It seems very determined in where it's bringing you. In the distance, you see an enormous constructions peeking through the clouds. And the dragon proceeds to fly directly to it": "这只野兽速度很快，但你已经坚持到现在！ 它把你带到哪里似乎非常坚定。 在远处，你看到一个巨大的建筑从云层中窥视。 龙直接飞向它",
    ...
    "Increases the amount of maximum health you gain after life by 10% per perk tier": "每级额外增加转生时获得的生命值上限 10%",
    ...
    "Provides 1 raw crab per completion (Can be cooked": "每次完成提供 1 只生蟹（可以烹饪",
    ...
    "gain after life by 50": "转生时获得 50",
    ...
    "Determines when the game triggers automatic save backups. Saves use approximately 100KB of disk-space per back-up, so the more often they are backed-up, the more disk-space they'll require.": "决定游戏何时触发自动存档备份。存档每次备份使用大约 100KB 的磁盘空间，因此备份的频率越高，所需的磁盘空间就越多。",
    ...
    "Pfeew, when you weren't stumbling over these roots, those nasty crabs kept pinching you as if you were intruding their territory. But you've managed to pass the swamp! Now that you're a bit closer, it seems that the smoke is coming from an abandoned campsite. Let's check that out!": "呼，当你不被这些树根绊倒的时候，那些可恶的螃蟹就好像你侵犯了它们的领地一样不停地捏你。 但是你已经设法通过了沼泽！ 现在你走近了一点，烟雾似乎是从一个废弃的营地里冒出来的。 让我们检查一下！",
    "You have successfully funneled some of the hourglass' power into your instincts! While the effect appears to be small on its own, it persists through generations permanently. Future generations will be able to funnel even more of its power into your instincts, but it will be even harder next time": "你已经成功地将一些沙漏的力量转化为你的直觉！ 虽然这种影响本身似乎很小，但它会永久持续几代人。 后代将能够将更多的力量注入你的直觉，但下一次会更难",
    "You have successfully funneled some of the shield's power into your hourglass! While limited on its own, the effect persists through generations permanently. Future generations will be able to funnel even more of its power into your hourglass, but it will be even harder next time": "你已经成功地将一些盾牌的力量汇集到你的沙漏中！ 虽然它本身是有限的，但这种影响会永久地代代相传。 子孙后代将能够将更多的力量注入你的沙漏中，但下一次会更难",
    "You have successfully funneled some of the dragon tooth's power into your hourglass! While the effect isn't too big by itself, it persists through generations permanently. Future generations will be able to funnel even more of its power into your instincts, but it will be even harder next time": "你已经成功地将一些龙牙的力量汇集到你的沙漏中！ 虽然影响本身并不太大，但它会永久持续几代人。 后代将能够将更多的力量注入你的直觉，但下一次会更难",
    "Well done, you've beaten the bull! The crowd keeps getting more excited as they watch you accomplish these challenges. Without even giving you a chance to catch your breath, a new cage opens and a lion enters the arena": "干得好，你打败了公牛！ 人群在看着您完成这些挑战时变得越来越兴奋。 甚至不给你喘口气的机会，一个新的笼子打开了，一只狮子进入了竞技场",
    "Poachers defeated! Those of them that still stand flee the scene. You should be able to try and free the dragon without further issues. From the poachers anyway": "偷猎者败北！ 那些仍然站着的人逃离了现场。 您应该能够尝试释放龙而不会出现其他问题。 无论如何来自偷猎者",
    "Now that the poachers are taken care of, let's see if this dragon lets you approach": "现在偷猎者已经解决了，让我们看看这条龙是否让你靠近",
    "Pfeew, all ropes cut! The dragon makes an almost purring sound, although it sounds more like an oven being heated. It did take some serious damage from the poachers, with all sorts of giant scratches and even some teeth missing. But it does seem able to fly to safety by itself. Before it does, it shoves one of its missing teeth towards you. Almost as if it knows that it may be of use to you. And it clearly is: your hourglass starts to tremble as it gets closer": "呼，所有的绳索都被切断了！ 龙发出几乎是咕噜咕噜的声音，虽然听起来更像是在加热的烤箱。 它确实受到了偷猎者的严重破坏，有各种巨大的划痕，甚至还有一些牙齿缺失。 但它似乎确实能够自己飞到安全的地方。 在它这样做之前，它会将其中一颗缺失的牙齿推向你。 就好像它知道它可能对你有用一样。 很明显：你的沙漏越靠近它就会开始颤抖",
    "Wow! You actually managed to beat the dragon in the treasury! I suppose it can be inhabited again. Although those who lived here are probably long gone by now": "哇！ 你居然在宝库中打败了巨龙！ 我想它可以再次有人居住。 虽然住在这里的人现在可能早已不在了",
    "She looks at you with a pale stare, somewhat frightened in a way that you recognize from the look in the elder's face. As if she recognizes something in you. She proceeds to tell you: \"I go by Amy these days. I came here to end the cycle. But now that you're here, I think I understand why it didn't work.": "她用苍白的目光看着你，你从长辈脸上的表情中可以看出她有些害怕。 好像她在你身上认出了什么东西。 她接着告诉你：“这些天我都叫艾米。我来这里是为了结束这个周期。但既然你在这里，我想我明白为什么它不起作用了。",
    "\"You don't remember me, do you? You've been here before.\" She proceeds to tell you: \"I go by Amy these days. I came here to end the cycle. But now that you're here, I think I understand why it didn't work.": "“你不记得我了，是吗？你以前来过这里。” 她接着告诉你：“这些天我都叫艾米。我来这里是为了结束这个周期。但既然你在这里，我想我明白为什么它不起作用了。",
    "\"I've told you everything I know. I don't know for certain what to do, as my actions haven't worked out how I hoped they would. I think you should look for the other artifacts to complete your hourglass. Find some of the others like us to help you out. And maybe, if at all possible, find the entombed one. It may have all started there. Now go, your ride is waiting!\" And as you look over her shoulder, you see a green dragon coming out of the volcanic smoke. It seems to recognize you, but you're unsure where from": "“我已经把我知道的都告诉你了。我不确定该怎么做，因为我的行动没有达到我希望的效果。我认为你应该寻找其他神器来完成你的沙漏。找到 其他一些人喜欢我们来帮助你。也许，如果可能的话，找到被埋葬的人。一切可能都是从那里开始的。现在走吧，你的车在等着你！” 当你越过她的肩膀看时，你会看到一条绿龙从火山烟雾中走出来。 它似乎认出了你，但你不确定从哪里来",
    "Expand the shrine for another 50%": "扩建神社来获得另外50%",
    "own 25 eggs": "拥有25枚鸡蛋",
    "(finish chep6)": "(完成章节6)",
    "(finish chep7)": "(完成章节7)",
    "(finish chep8)": "(完成章节8)",
    ...
    "It appears that the camp was from the same tribe that you've met on the beach. But all they left behind was an empty pan": "营地似乎来自你在海滩上遇到的同一个部落。 但他们留下的只是一个空锅",
    "A fairly old person with a face covered in soot. The blacksmith appears busy, but maybe you can get some quick questions in!": "一个满脸烟灰的老者。 铁匠看起来很忙，但也许你可以快速提问！",
    "A rare collection of pearls beautifully woven into a necklace. If it wasn't for the incredibly high price, you wouldn't believe anyone would sell such a treasure": "珍稀珍珠系列，精美编织成一条项链。 要不是天价高，你都不敢相信会有人卖这样的宝物",
    "agility skill by 25": "敏捷技能25",
    "agility skill by 25%": "敏捷技能提升25%！",
    "agility skill by 25%!": "敏捷技能提升25%！",
    "Coming down! A set of cocowood soles that increase the multiplier of your": "下来！ 一套椰子木鞋底，增加你的乘数",
    "Completing this job removes food from your inventory until a total food value of at least 1.00e6 is provided. Food that isn't available within the city is worth twice as much as its food value, due to popular demand": "完成这项工作将从您的库存中移除食物，直到提供至少 1.00e6 的总食物价值。 由于大众需求，城市内无法获得的食物价值是其食物价值的两倍",
    "Increases the multiplier of all your skills by 10": "将你所有技能的乘数提高 10",
    "maximum health, but replaces your iron belt if you have one (you don't": "最大生命值，但替换你的铁腰带（你没有",
    "Sell some of your food in return for a wooden chip (A simple coin used for trading during the trade fair": "卖掉你的一些食物以换取木片（一种在交易会期间用于交易的简单硬币",
    "Since you already own both, this has no additional value to you": "由于您已经拥有两者，因此这对您没有额外价值",
    "There's someone at the top of the waterfall cleaning debris and making gestures at you. Let's hear what that's about. With a bit of shouting to understand one another. Since the cleaner is standing on top of the waterfall and you're not": "瀑布顶部有人清理碎片并向您做手势。 让我们听听这是怎么回事。 为了互相理解而大喊大叫。 因为清洁工站在瀑布的顶部而你不是",
    "To keep competition fair, you're not allowed to resell this food": "为了保持公平竞争，您不得转售该食品",
    "You already own cocowood soles, so you have no use for this debris": "你已经拥有椰子木鞋底，所以你不需要这些碎片",
    "Well, you figured it out! The mushrooms with the red caps are the poisonous ones. And the dull looking mushrooms are somewhat edible! You should be able to use this knowledge throughout the entire city within the mountain": "好吧，你想通了！ 带红色帽子的蘑菇是有毒的。 看起来暗淡的蘑菇有点可食用！ 你应该可以在山区内的整个城市使用这些知识",
	"\"If I throw this stuff down, could you catch it for me so it doesn't harm bystanders? I'll let you keep whatever you catch!\". You can't help but feel like this is a very impractical approach to it, but don't want to be rude either": "“如果我把这东西扔下去，你能不能帮我接住它，这样它就不会伤害旁观者？我会让你保留你抓到的东西！”。 你会忍不住觉得这是一种非常不切实际的方法，但也不想变得粗鲁",
	"Coming down! A set of cocowood soles that increase the multiplier of your": "下来！ 一套椰子木鞋底，让你的",
	"agility skill by 25%! You catch it, you keep it!": "敏捷技能倍数提高25%！ 你抓住它，你保留它！",
	"Somehow trying to catch any form of footwear always hurts more than it should. But you've managed to catch the cocowood soles and the waterfall is a little clearer already! There are still some bigger objects stuck up there though": "不知何故，试图抓住任何形式的鞋类总是比它应该受到的伤害更大。 但是你已经抓住了椰子木鞋底，瀑布已经更清澈了！ 尽管如此，仍然有一些更大的物体卡在那里",
	"The doubts you had about this cleaning approach continue to grow. There must be a better way to clear this out than catching carts by hand? Anyhow, you've managed!": "您对这种清洁方法的疑虑不断增加。 一定有比用手抓手推车更好的方法来解决这个问题吗？ 总之，你成功了！",
	"Used to ignite fires": "用来点燃火",
	"Well, that's that! The waterfall is mostly cleared, or at least clear enough to no longer require your help to finish up. The cleaner excitedly thanks you for your assistance!": "嗯，就是这样！ 瀑布大部分已清理干净，或者至少清理得足够干净，不再需要您的帮助才能完成。 清洁工兴奋地感谢您的帮助！",
    "Watch your head! A cocowood cart that increases your": "小心碰头！ 椰子车使你的",
    "If you manage to catch it intact, you can keep it!": "如果你设法完好无损地抓住它，你可以保留它！",
    "You already own a cocowood cart, so you have no use for this debris": "已经拥有一辆椰子车，所以你不需要这些碎片",
    "This is really getting out of hand. A wooden statue that doubles your": "这真是失控了。 木制雕像翻倍你的",
    "Completing this job removes food from your inventory until a total food value of at least": "完成这项工作将从您的库存中移除食物，直到提供至少",
    "is provided. Food that isn't available within the city is worth twice as much as its food value, due to popular demand": "的总食物价值。 由于大众需求，城市内无法获得的食物价值是其食物价值的两倍",
    "Food trade": "交易食物",
    "A simple coin used for trading during the trade fair": "交易会期间用于交易的简单硬币",
    "Contains a wooden bow and a copper shovel, which increase the skill multipliers of  digging and  hunting by 25%. These are the same tools as were available in the chapter 5 city, and do not stack.": "内含木弓一把和铜铲一把，增加挖掘和狩猎技能倍数25%。 这些工具与第 5 章城市中可用的工具相同，并且不叠加。",
	"You can keep the iron stick if you manage to take it from the dog. It increases the multiplier of your  combat skill by 25%.": "如果你设法从狗身上拿走铁棒，你可以保留它。 它使你的  战斗技能的乘数增加 25%。",
	"You have a gut feeling that there might be more to this dog than meets the eye": "你有一种直觉，这只狗可能比你看到的更多",
	"And since you don't own an iron stick yet, it may just come in handy!": "由于您还没有铁棒，它可能会派上用场！",
	"Some locals in ceremonial robes are awaiting you, let's find out what they can tell you about this vault": "一些穿着礼仪长袍的当地人正在等你，让我们看看他们能告诉你关于这个金库的什么",
	"Ask the keepers who the Architect is": "询问管理员谁是建筑师",
	"\"Ah of course, you're not from around here and couldn't know this. Our ancestors used to follow the Architect on his journey. He was believed to hold the knowledge of a hundred lifetimes. He parted ways with our ancestors after completing the construction of the vault, leaving us with the task of guarding it against entry of unworthy thieves or demolishers\". You can't help but feel that this Architect may just be similar to Amy and you. But how would they remember, if he truly was? Let's see if you can open the vault!": "“啊，当然，你不是这附近的人，不可能知道这些。我们的祖先曾经跟随建筑师的旅程。他被认为拥有一百生世的知识。他在完成后与我们的祖先分道扬镳。 完成金库的建造，留给我们的任务是防止不值得的窃贼或破坏者进入”。 您不禁会觉得，这位 建筑师 可能只是类似于 艾米 和您。 但他们怎么会记得，如果他真的是？ 让我们看看您是否可以打开金库！",
	"It took quite a bit of tricky moves and a few hits before the flock decided to move along, but they seem convinced not to mess with you any more. That leaves the rest of their shiny possessions to you!": "在羊群决定继续前进之前，它采取了相当多的棘手动作和几次打击，但他们似乎确信不再惹你了。 他们剩下的闪亮财产就留给你了！",
	"Let's look around to see if there's some sort of mechanism to open it. It's definitely not as simple as a door handle": "让我们四处看看是否有某种机制可以打开它。 绝对不是门把手那么简单",
	"Now that you've scared all the crows away, you can comfortably empty their nest": "既然你已经把所有的乌鸦都吓跑了，你就可以轻松地清空它们的巢穴了",
	"It remains surprising just how much these birds managed to store in such a small nest. Oh well, it's yours now!": "令人惊讶的是，这些鸟在这么小的巢穴中储存了多少东西。 哦，好吧，现在是你的了！",
	"Use your hourglass to attempt opening the vault": "使用你的沙漏尝试打开金库",
	"Let's see if they have any final advice before you enter the vault!": "在您进入金库之前，让我们看看他们是否有任何最终建议！",
	"Enter the Architect's vault. By entering the vault, you'll lose access to food sources in the city. You'll also leave construction resources behind to free up inventory space": "进入建筑师的金库。 进入金库后，您将无法获得城市中的食物来源。 您还将留下建筑资源以释放库存空间",
	"combat type": "战斗类型",
	"dodge type": "闪避类型",
	"block type": "格挡类型",
	"Stone Titan 100% health": "石泰坦 100% 生命值",
	"When you tripped the titan, it lost its balance for a step or two, smashing one of the surrounding walls. This caused parts of the ceiling to fall down, some of which hit you. However, you do notice some shells attached to it!": "当你绊倒泰坦时，它会失去平衡一两步，砸碎周围的一堵墙。 这导致部分天花板掉落，其中一些击中了你。 但是，您确实注意到它附有一些贝壳！",
	"Following five successive blocks, the titan seems to have lost its balance for a bit, giving you a nice opening to strike!": "在连续五个格挡之后，泰坦似乎有点失去平衡，给你一个很好的攻击机会！",
	"Provides 1 gollum clam per completion (A thick shell, with something edible inside": "每次完成提供 1 个咕噜蛤蜊（厚壳，里面有可食用的东西",
	"A thick shell, with something edible inside": "厚厚的外壳，里面有可食用的东西",
	"Stone titan 80% health": "石泰坦 80% 生命值",
	"After taking a notable amount of damage, the Titan appears to be staggered for a bit. That gives you the chance to finally look around a little better in the vault. You spot some sort of leftover construction site a little further in. Let's see if you can reach that before the Titan recovers!": "在受到大量伤害后，泰坦似乎有些惊慌失措。 这使您有机会最终在金库中更好地环顾四周。 你在更远的地方发现了一些遗留的建筑工地。让我们看看你能否在泰坦恢复之前到达那里！",
	"With the titan staggered for a bit, you've spotted some sort of leftover construction site a little further in. This is your chance to run to it!": "随着泰坦摇摇晃晃，您已经在更远的地方发现了某种遗留的建筑工地。这是您奔向它的机会！",
	"At first glance, it looks as if this was left over by the creator of the Titan. Some resources are hard to identify, but you should find some use for them! But wait, the titan has recollected itself and starts taking aim at you from a distance!": "乍一看，这似乎是泰坦的创造者留下来的。 有些资源很难识别，但您应该找到它们的用处！ 但是等等，泰坦已经回过神来，开始从远处瞄准你！",
	"There's some wood left among the debris, but it appears to be rather ancient. You should still be able to salvage some usable pieces from it. Provides 1 moldy wood per completion (Not in the best shape, but it should be viable for construction": "废墟中还有一些木头，但看起来相当古老。 您仍然应该能够从中回收一些可用的部件。 每次完成提供 1 个发霉的木材（不是最好的形状，但它应该可以用于建造",
	"Not in the best shape, but it should be viable for construction": "不是最好的形状，但它应该是可行的",
	"A pile of massive stones that appear to have been used for the construction of the Titan itself. Provides 1 titan stone per completion (This can probably be used for constructions other than titans too": "一堆巨石，似乎是用来建造泰坦本身的。 每次完成提供 1 个泰坦石（这可能也可用于泰坦以外的建筑",
	"This can probably be used for constructions other than titans too": "这可能也可用于泰坦以外的建筑",
	"You should be able to launch debris with such a tool! Although it'll need to be loaded after completion": "你应该能够用这样的工具发射碎片！ 虽然完成后需要加载",
	"Are you sure you have the time to build this while the titan is firing arrows at you?": "你确定你有时间在泰坦向你射箭的时候建造这个吗？",
	"Return to the Titan to continue combat and stop its ranged barrage. You'll probably want to complete as many constructions as you can, before its arrows become overwhelming": "返回泰坦继续战斗并停止其远程弹幕。 在箭矢变得势不可挡之前，您可能希望尽可能多地完成构造",
	"Load your catapult with some debris for maximum fire power! But you'll need to reload it again after firing your catapult": "为你的弹射器装上一些碎片以获得最大的火力！ 但是你需要在发射弹射器后重新装弹",
	"Returned to titan": "返回泰坦",
	"By returning to the titan, you've interrupted the arrow barrage. Instead the titan continues its melee sequence": "通过返回泰坦，你已经打断了箭雨。 相反，泰坦继续其近战序列",
	"Fire your catapult at the titan to damage it from a distance! This requires a loaded catapult to work": "向泰坦发射你的弹射器，从远处对其造成伤害！ 这需要加载弹射器才能工作",
	"Can be completed up to ten times before the titan learns to dodge your shots, but gets harder with every successful shot up until that point": "在泰坦学会躲避你的射击之前最多可以完成 10 次，但在此之前每次成功射击都会变得更难",
	"You notice some insects flying in and out of a small opening in the ceiling. You could fire your catapult at it to see what that does? Requires a loaded catapult to work": "你注意到一些昆虫从天花板上的一个小开口飞进飞出。 您可以向它发射弹射器，看看它有什么作用？ 需要装载的弹射器才能工作",
	"That did the trick! A fairly big part of the ceiling, certainly more than you intended to, came crashing down after you hit it. You notice some sort of insect hives that were previously behind the crack in the ceiling, now fully exposed. They didn't quite fall down though, so you'll need a more accurate ranged tool to shoot those down": "成功了！ 天花板的很大一部分，肯定比你预期的要多，在你撞到它之后就崩塌了。 你注意到以前在天花板裂缝后面的某种昆虫蜂巢，现在完全暴露在外。 不过它们并没有完全倒下，所以你需要一个更精确的远程工具来击落它们",
	"Stone titan 40% health": "石泰坦 40% 生命值",
	"The titan starts to tremble, almost as if it's somehow overheating. The sheer size of it causes what feels like an earthquake. While that doesn't directly harm you, you notice the vault itself is slowly starting to collapse, and debris starts falling from the ceiling": "泰坦开始颤抖，就好像它不知为何过热了一样。 它的巨大规模导致感觉像地震。 虽然这不会直接伤害到你，但你会注意到保险库本身正在慢慢开始倒塌，碎片开始从天花板上掉落",
	"Requires a slingshot to fire with enough accuracy, but it doesn't look like you've bought one from the kids in town": "需要弹弓才能足够准确地射击，但看起来不像是从城里的孩子那里买的",
	"Stone titan 20% health": "石泰坦 20% 生命值",
	"It appears that the titan is going into some sort of emergency-mode, and a bright light starts shining from behind its chestplate, followed by a significant shockwave that causes one of the vault's walls to come down. That wall appears to contain some fungi growing on it! Your hourglass seems to respond to the light behind the titan's chestplate somehow, but you don't really have a chance to figure out why that is just now": "泰坦似乎进入了某种紧急模式，一道强光从它的胸甲后面开始闪耀，随后是强烈的冲击波，导致金库的一堵墙倒塌。 那堵墙似乎有一些真菌生长在上面！ 你的沙漏似乎以某种方式对泰坦胸甲后面的光做出了反应，但你真的没有机会弄清楚为什么会这样",
	"Pick portobello": "采摘双孢蘑菇",
	"Luckily you've had some mushroom training, so you know which ones to gather!": "幸运的是你接受过一些蘑菇训练，所以你知道该采哪些蘑菇！",
	"If only you would have had some mushroom training. You can't really tell which ones to gather, so let's play it safe and not gather them for now": "要是你能接受一些蘑菇训练就好了。 你真的不知道要收集哪些，所以让我们谨慎行事，暂时不要收集它们",
	"Portobello": "双孢蘑菇",
	...
	"Completing this permanently reduces the damage on completion (not on failure) of explorations, jobs and hostile actions by 1% for all future generations, as well as your current generation.": "完成此任务后，所有子孙后代以及您这一代人的探索、工作和敌对行动的完成（而非失败）的损害将永久降低 1%。",
	"Completing this exploration in multiple generations compounds the permanent bonus, but the difficulty increases per completion": "在多代人中完成此探索会增加永久奖励，但难度会随着每次完成而增加",
	"You have successfully funneled some of the titan core's power into your hourglass! While limited on its own, the effect persists through generations permanently. Future generations will be able to funnel even more of its power into your hourglass, but it will be even harder next time": "你已经成功地将一些泰坦核心的力量汇集到你的沙漏中！ 虽然它本身是有限的，但这种影响会永久地代代相传。 子孙后代将能够将更多的力量注入你的沙漏中，但下一次会更难",
	"Use your hourglass to disable the titan core. There's no way around it, this is going to hurt": "使用你的沙漏来禁用泰坦核心。 这是没有办法的，这会很痛",
	"Oof, that was quite the shockwave! Everything around you moved back by a fair distance all of a sudden. Most of the vault's remaining pillars collapsed, if you can even call it a vault at this point. As the inscriptions indicated, a passage opened in a corner of the vault. Passage is a big word though, it seems that that wall was just a little weaker by design": "哦，那是相当强的冲击波！ 你周围的一切突然后退了一段距离。 大部分金库的剩余柱子都倒塌了，如果你在这一点上甚至可以称它为金库的话。 正如铭文所指示的那样，在金库的一角打开了一条通道。 虽然通道是一个大词，但似乎那堵墙在设计上有点薄弱",
	"Exit the vault through the passage that was created by the blast of disabling the titan's core": "通过禁用泰坦核心的爆炸产生的通道退出金库",
	"It takes your eyes a second to adapt to the light after being in the vault for so long. Even if light managed to shine through the holes in the ceiling, this direct sunlight is a little uneasy on the eyes, yet feels quite welcome. After your eyes have had a chance to adapt, you see that this side of the vault was certainly never a regular passage, but only water finds its way down here. Let's see if you can find a way down!": "在金库里呆了这么久，你的眼睛需要一秒钟的时间来适应光线。 即使光线设法从天花板上的孔中照进来，这种直射的阳光对眼睛来说还是有点不舒服，但感觉还是很受欢迎的。 在你的眼睛有机会适应之后，你会看到拱顶的这一侧肯定不是常规通道，而是只有水流到这里。 让我们看看你能不能找到一条路下来！",
	"If only you would have had some mushroom training. You can't really tell which ones to gather, so let's play it safe and not gather them for now": "要是你能接受一些蘑菇训练就好了。 你真的不知道要收集哪些，所以让我们谨慎行事，暂时不要收集它们",
    ...
    "Provides 1 limestone per completion (Used for construction": "每次完成提供 1 个石灰石（用于建造",
    "Provides 1 clay per completion (Used for construction": "每次完成提供 1 个粘土（用于建造",
    "Provides 1 dead falcon per completion (Can be cooked": "每次完成提供 1 只死猎鹰（可以烹饪",
    ...
    "Provides 1 citrus wood per completion (Used for construction": "每次完成提供 1 个柑橘木（用于建造",
    "Provides 1 cocowood per completion (Used for construction": "每次完成提供 1 个椰木（用于建造",
    "Provides 1 dead boar (Not for raw consumption) and 1 hide (Used for construction) per completion": "每次完成提供 1 头死掉的野猪（不用于生食）和 1 块野猪皮（用于建造）",
    ...
    "Provides 1 copper per completion (Used for construction": "每个完成提供 1 铜（用于建造",
    ...
    "Provides 1 iron per completion (Used for construction": "每次完成提供 1 个铁（用于建造",
    "Provides 1 cooked egg per completion (It's for the children. Eating it would be very rude": "每次完成提供 1 个煮熟的鸡蛋（这是给孩子的。吃它会很粗鲁",
    "It's for the children. Eating it would be very rude": "这是给孩子的。吃它会很粗鲁",
    ...
    "that": "",
    "Approach debris": "接近残骸",
    "Approach dog": "靠近狗",
    "Approach statue": "接近雕像",
    "Approach vault": "接近金库",
    "Attack titan": "攻击泰坦",
    "Back-up frequency": "后备频率",
    "Backshot titan": "背射泰坦",
    "Block titan": "格挡泰坦",
    "Buy mixed salad": "买沙拉",
    "Buy packed meal": "买盒饭",
    ...
    "Catch soles": "抓住鞋子",
    "Catch statue": "抓住雕像",
    "Ceremonial fire": "礼仪之火",
    "Chapter completions": "章节完成",
    "Classic toolkit": "经典工具包",
    "Climb back up": "往回爬",
    "Climb to low layer": "向下爬",
    "Coal lump": "煤块",
    "Combat is automatically canceled if there is a high chance of being lethal, unless you can't do anything else": "如果有很高的死亡几率，这个动作将自动取消，除非你不能做任何其他事情",
    "Continue cliff chat": "继续悬崖边的谈话",
    "Cook clam": "煮蛤蜊",
    "Cook koi": "煮锦鲤",
    "Cooked clam": "煮熟的蛤蜊",
    "Cooked koi": "煮熟的锦鲤",
    "Counter titan": "反击泰坦",
    "Cross clouds": "穿过云层",
    "Cut moldy wood": "切割发霉的木头",
    "Dig titan stone": "挖泰坦石",
    "Disable titan core": "关闭泰坦核心",
    "Dodge titan": "闪避泰坦",
    "Emergency repair": "紧急维修",
    "Empty nest": "搜刮巢穴",
    "Enemy": "敌人",
    "Enter forage shack": "进入草棚",
    "Enter main square": "进入中心广场",
    "Enter mountain": "进山",
    "Enter the crowd": "混入人群",
    "Enter the vault": "进入金库",
    "Exit shack": "离开草棚",
    "Exit the square": "离开广场",
    "Exit the vault": "离开金库",
    "Exit top layer": "离开顶层",
    "Falling debris": "陨落的碎片",
    "Fire at ceiling": "向天花板射击",
    "Fire at titan": "向泰坦射击",
    "Follow dog": "跟随狗",
    "Funnel titan core": "漏斗泰坦核心",
    "Gather clam": "收集蛤蜊",
    "Gather mushroom": "收集蘑菇",
    "Gather steel": "收集钢材",
    "Gollum clam": "咕噜蛤蜊",
    "Honey": "蜂蜜",
    "Hostile actions": "敌对行动",
    "If the game fails to launch, please try to verify the installation file integrity through Steam. More details can be found pinned in the Steam Community Discussions": "如果游戏无法启动，请尝试通过Steam验证安装文件的完整性。更多细节可以在Steam社区讨论中找到。",
    "Ignite the fire": "点燃礼仪之火",
    "Inspect core": "检查核心",
    "Inspect vault": "检查金库",
    "Introduce yourself": "自我介绍",
    "It looks like people may have passed through here, but those monkeys seem more interested in the food in your inventory than anything else": "看起来可能有人经过这里，但那些猴子似乎对你库存中的食物更感兴趣。",
    "Land on cliff": "悬崖着陆",
    "Load catapult": "装填弹弓",
    "Meet blacksmith": "认识铁匠",
    "Meet cleaner": "认识清洁工",
    "Meet cliff people": "认识悬崖边的人们",
    "Meet forager": "认识觅食者",
    "Meet keepers": "认识看守者",
    "Mixed salad": "沙拉",
    "Moldy wood": "发霉的木头",
    "Mushroom": "蘑菇",
    "Mushroom school": "蘑菇辨识",
    "Offline time": "离线时间",
    "Oh wow, you've actually beaten that jaguar! No reason to sneak around now, the rest of them won't try to bother you. Now that you're able to look around freely, you see smoke coming from an abandoned camp ahead. Might as well check that out!": "哦，哇，你真的打败了美洲虎!”现在没必要偷偷摸摸了，其他人不会来打扰你的。现在你可以自由地环顾四周，你看到前面一个废弃的营地冒出了烟雾。不妨去看看!",
    "Open vault door": "打开金库门",
    "Packed meal": "盒饭",
    "Pearl necklace": "珍珠项链",
    "Pillage nest": "掠夺巢穴",
    "Raw koi carp": "生锦鲤",
    "Requires a cocowood cart to expand": "需要一辆椰木车才能扩张",
    "Requires a stone cart to expand": "需要一辆石车才能扩张",
    "Requires a wooden cart to expand": "需要一辆木车才能扩张",
    "Return to titan": "接近泰坦",
    "Sell food": "卖食物",
    "Shield rejected. Whether or not that was a good decision is unclear, but the crowd definitely likes it!": "拒绝盾牌。这是否是一个正确的决定还不清楚，但观众们肯定很喜欢!",
    "Shoo crows": "安抚乌鸦",
    "Shoot beehive": "射击蜂箱",
    "Shovel coal": "铲煤",
    "Slingshot": "弹弓",
    ...
    "Steel fork": "钢叉",
    "Steel hut": "钢屋",
    "Take dog's toy": "拿走狗的玩具",
    "Talk to keepers": "与看守者交谈",
    "That's what we call a leap of faith! But you've actually managed to make it across the gorge in one jump! You hear the sound of monkeys in the distance. It's probably a good idea to check on that commotion": "这就是我们所说的信念飞跃!但是你真的成功地一跳就跳过了峡谷!你听到远处猴子的叫声。去看看那里的骚动情况也许是个好主意",
    "The Architect?": "建筑师？",
    "There's a lot of commotion in hightown. It seem like today is their annual sports competition, with some cool prizes that you can cash for tools. It appears that the prizes are silver coins, of which you already have some! Let's see what the vendor has to offer": "在内城有很多骚动。今天似乎是他们一年一度的体育比赛，有一些很酷的奖品，你可以用现金换工具。看来奖品是银币，你已经有一些了!让我们看看卖家能提供什么",
    "This action is automatically canceled if there is a high chance of being lethal, unless you can't do anything else": "如果有很高的死亡几率，这个动作将自动取消，除非你不能做任何其他事情",
    "This should not take more than a second.": "这不会超过一秒钟",
    "Titan arrow": "泰坦箭",
    "Titan stone": "泰坦石",
    "Titanstone hut": "泰坦石房",
    "Trip titan": "绊倒泰坦",
    "Walk to top layer": "走向世界最高峰",
    "Walk to waterfall": "走向瀑布",
    "Wooden chip": "木片",
    "A little shack that looks open. It has a little sign outside that appears to portray a mushroom": "一个看起来敞开的小棚屋。它外面有一个小标志，看起来像一个蘑菇",
    "Approach the vault in the center of this city. A massive door that's easily six times your size and visible from almost anywhere in town. But it's common courtesy to visit the other parts of town first!": "接近这座城市中心的金库。一扇巨大的门，大小是你的六倍，几乎在镇上的任何地方都能看到。但是先去城里的其他地方看看是礼貌的!",
    "It's quite a few stairs down, but nothing else is stopping you from going to the lower layer of the city": "这是相当多的楼梯下，但没有什么是阻止你去城市的下层",
    "jobs for empty food": "空食物的工作",
    "Leave the forager's shack and continue exploring the lower layer of the city": "离开觅食者的窝棚，继续探索城市的底层",
    "Proceed to fly through the clouds, towards the construction that the dragon seems to bring you to": "继续飞越云层，朝着龙似乎要带你去的建筑飞去",
    "Proceed to meet the people on the cliff": "继续和悬崖上的人会合",
    "Provides 1 raw koi carp per completion (Colorful and cookable": "每次完成可提供1条生锦鲤(颜色丰富，可烹饪",
    "Read inscription": "阅读碑文",
    "Recent generations": "最近的几代人",
    "Save auto-backups": "自动备份",
    "The forager has a rather suboptimal way to teach you which mushrooms are edible. Just taste the mushrooms until you figure out which ones aren't toxic. This might have some unfortunate consequences on your stomach in the meantime": "觅食者有一个相当不理想的方法来告诉你哪些蘑菇是可食用的。品尝蘑菇，直到你知道哪些是无毒的。与此同时，这可能会对你的胃产生一些不幸的后果",
    "The forager looks excited to meet someone that's interested in the mushroom collection!": "觅食者看起来很兴奋见到对蘑菇收藏感兴趣的人!",
    "These people seem to live inside the mountain itself. As if they used the mountain as the foundation of their city and dug through it": "这些人似乎就住在山里面。就好像他们把这座山作为城市的基础，挖通了它",
    "They appear to be staring at you. Who can blame them though? You've just arrived on the back of a dragon": "他们似乎在盯着你看。谁能责怪他们呢?你是骑着龙来的",
    "This area is entirely paved, so you won't be able to gather local food sources in the main square": "这个区域完全是铺好的，所以你不能在主广场上收集当地的食物来源",
    "This cliff looks like it should be a relatively safe landing zone. But hold on tight. Hanging on to the dragon as it tries to land may be a little tricky": "这个悬崖看起来应该是一个相对安全的着陆区。但要抓紧。在龙试图着陆时抓住它可能有点棘手",
    "Trigger in menus": "菜单中的触发器",
    "Trigger in reincarnation screen": "在转世画面中触发",
    "Walk past the shacks to a waterfall at the end of the lower layer of the city. It appears to be their source of drinking water within the mountain": "走过棚屋，来到城市底层尽头的瀑布前。这似乎是他们在山里的饮用水来源",
    "You can right-click perks to refund their full value. Allowing you to freely reallocate your DNA between new game+ runs (but not during a playthrough": "你可以右键单击津贴以全额退款。允许你在新游戏+运行之间自由地重新分配你的DNA(但不是在游戏过程中",
    "You hear commotion coming from the center area of the city.": "你听到从城市中心传来的骚动。",
    "You see some smoke coming from the higher layer of the city": "你看到一些烟雾从城市的上层升起",
	"A new update was successfully installed since you've last played.": "自从你上次玩游戏以来，新更新已成功安装。",
	"After a little staring in disbelief, one of the people on the cliff starts talking: \"A dragon rider?! Those were supposed to be legends\". But before continuing they notice that you're looking fairly hungry, and point you towards their koi pond. It looks like they have a bit of an overpopulation problem in the pond, so seem to be totally ok with you catching some": "在难以置信地盯了一会儿之后，悬崖上的一个人开始说话:“龙骑士?!那些都是传说。”但在继续之前，他们注意到你看起来很饿，并把你指向他们的锦鲤池。看起来它们在池塘里有一些人口过剩的问题，所以看起来你完全可以抓一些。",
	"After a very pleasant chat, the baker decided to share an old family recipe for cake with you! It takes quite a while to bake, but it tastes better than bread! The baker decided to also share an old family secret with you: \"Baking works better in an oven than on a campfire\"": "在一次非常愉快的交谈之后，面包师决定和你们分享一个古老的家庭蛋糕食谱!烤起来要花不少时间，但比面包好吃!面包师还决定和你分享一个古老的家庭秘密:“在烤箱里烤比在篝火上烤更好。”",
	"After quite a few stairs, you've made it to the lower layer of the city within the mountain. It's notably humid in this area, and seems to house a fair amount of people. Some of the little shacks down here seem welcoming, while others are clearly closed": "走了好几个台阶，你就到了山中城市的下层。这个地区特别潮湿，似乎可以容纳相当多的人。这里的一些小棚屋似乎很受欢迎，而另一些显然已经关门了。",
	"After successfully dodging the titan three times, you see a chance to fire an arrow at its back!": "在成功躲避泰坦三次后，你有机会向它的背部射出一箭!",
	"After successfully dodging the titan three times, you see a chance to trip it, causing it to lose its balance! That might just result in something useful": "在成功躲避泰坦三次后，你看到一个绊倒它的机会，使它失去平衡!这可能会产生一些有用的东西。",
	"After walking through the entrance on the cliff, you can't help but feel surprised by how many people actually live inside this mountain. It must be housing hundreds. Luckily for you, there's koi ponds everywhere and the overpopulation in those ponds is notable. That said, there's stairs everywhere, and one enormous fortified vault in the middle of the city. It appears that you're welcome to travel through the city on your own": "穿过悬崖入口后，你会情不自禁地惊讶于这座山里到底住着多少人。它肯定容纳了数百人。幸运的是，这里到处都是锦鲤池塘，池塘里的锦鲤数量过多是很明显的。也就是说，到处都是楼梯，在城市中心还有一个巨大的加固拱顶。看来欢迎你自己在城市里旅行。",
	"As you approach the vault, you can't help but feel impressed by just how enormous this door is. What could possibly have needed a door this big? You notice that some locals in ceremonial robes are awaiting you. It looks like they've been preparing for this day. But the well-worn state of their robes suggests that time has caused preparations to become more of an old tradition rather than anything else. Yet their faces indicate something between solemnity and an overwhelming surprise they are trying to mask": "当你走近金库时，你会情不自禁地对这扇门的巨大印象深刻。怎么会需要这么大的门呢?你注意到一些穿着仪式长袍的当地人在等着你。看起来他们一直在为这一天做准备。但他们的长袍已经破旧不堪，这表明时间已经使准备工作成为一种古老的传统，而不是其他任何东西。然而，他们的表情显示出某种介于他们试图掩盖的庄严和压倒性的惊讶之间的东西。",
	"As you get closer to the center of the vault door, your hourglass starts to tremble. As if these things are somehow linked? Perhaps your hourglass is the key to opening this door": "当你接近金库门的中心时，你的沙漏开始颤抖。好像这些东西有某种联系吗?也许你的沙漏就是打开这扇门的钥匙",
	"As you get somewhat close, it quickly becomes very clear that this isn't a real statue. The stone limbs start moving, making sounds as if the cave itself is moving. This thing clearly isn't what the vault is guarding. It's another layer of defense": "当你走近一点，很快就会发现这不是一座真正的雕像。石头的四肢开始移动，发出声音就好像洞穴本身也在移动。这东西显然不是金库守护的东西。这是另一层防御。",
	"block type actions to become more difficult with every completion of this action": "随着动作的每一次完成，阻挡类型的动作变得更加困难",
	"Colorful and cookable": "色彩丰富，可烹饪",
	"combat skill by 25%.": "战斗技能提高25%。",
	"combat type actions to become more difficult with every completion of this action": "战斗类型的行动随着每一个行动的完成而变得更加困难",
	"Completed this generation": "完成这一代",
	"Completing this action reduces the": "完成此操作将减少",
	"Contains a wooden bow and a copper shovel, which increase the skill multipliers of": "包含一把木弓和一把铜铲，可以增加技能倍增系数",
	"digging and": "挖掘和",
	"dodge type actions": "闪避类型动作",
	"dodge type actions to become more difficult with every completion of this action": "闪避类型的行动变得更加困难的每一个完成这个行动",
	"During boss fights, only milestones such as health thresholds or unique explorations advance the story, rather than every exploration": "在boss战中，只有生命值阈值或独特的探索等里程碑才能推动故事发展，而不是每一次探索。",
	"Find the update notes on Steam": "在Steam上找到更新说明",
	"Game update detected!": "检测到游戏更新!",
	"Game version: 15 March 2023": "游戏版本:2023年3月15日",
	"15 March 2023": "2023年3月15日",
	"Gorilla, beaten. That'll show them not to mess with you! The other monkeys quickly flee the scene. No food for them today!": "大猩猩,殴打。这样他们就不会惹你了!其他猴子迅速逃离现场。今天没有给他们吃的了!",
	"Hardly comfortable, but very robust. Lowers": "不太舒服，但很结实。降低",
	"However, you already own an iron stick, so you have no use for it": "可是，你已经有了一根铁棒，用不着它了。",
	"hunting by 25%. These are the same tools as were available in the chapter 5 city, and do not stack.": "狩猎技能加成25%。这些工具与第5章中的城市是一样的，并且不能叠加。",
	"If this thing is going to hit you, you'd better be prepared!": "如果这东西要打到你，你最好做好准备!",
	"Ignite the fire to ceremonially start the festivities!": "点燃火，正式开始庆祝活动!",
	"Increases the health value of all your food by 10% for the rest of this generation, without any penalty": "为这一代人增加10%的食物健康价值，没有任何惩罚",
	"It appears as if they are preparing a trade fair in the square. You hear some people talking about Prophecy Day. Has this something to do with your entrance? Either way, let's see if you can help out!": "看起来他们好像在广场上准备一个交易会。你听到一些人在谈论预言日。这和你的进入有关系吗?不管怎样，让我们看看你能不能帮忙!",
	"It started a little smokey, but eased into a beautiful fire in no time! The festivities are ready to begin! The square is getting really busy really quickly. You hear some people talking about the trade fair, as if they do this every other week. Maybe they were just looking for an excuse to throw another fair": "一开始是烟雾，但很快就变成了美丽的火焰!庆祝活动准备开始了!广场很快就会变得非常繁忙。你听到一些人在谈论交易会，好像他们每隔一周就会举办一次似的。也许他们只是想找个借口再办一次博览会。",
	"It worked! Channeling your hourglass in front of the door started lighting up symbols engraved in the door initially, until it eventually started making loud noises before opening slightly. It should be far enough open for you to enter now! Let's see if the keepers have any final advice for you": "这有效!引导你在门前的沙漏开始点亮刻在门上的符号，直到它最终开始发出巨大的声音，然后轻轻地打开。应该已经开得够远了，你们可以进去了!让我们看看看守者有没有什么最后的建议给你。",
	"Leave the lower layer and return to the entrance of the city": "离开下层，回到城口",
	"maximum health, but replaces your iron belt if you have one (you do, effectively making this a 33.3% bonus": "最大生命值，但如果你有铁带，就替换铁带(你有，有效地使其增加33.3%",
	"Mingle with the people in the main square to find out what's going on": "和主广场上的人打成一片，看看发生了什么事。",
	"Now that the crows fled from the dog, let's grab everything valuable from their nest!": "现在乌鸦已经从狗那里逃走了，让我们从他们的巢里抢一切值钱的东西吧!",
	"Now that you've passed through the most dense parts of the clouds, you have a fairly clear view of where the dragon is bringing you. It looks as if a whole civilization has taken residence within a mountain. The construction appears to use the mountain itself as a foundation, whereas both smoke and light exit through various what appear to be windows. Getting closer, one cliff seems to stick out a fair bit. It looks like the dragon is aiming to land there": "现在你已经穿过了云层最密集的部分，你可以相当清楚地看到龙要带你去哪里。看起来好像整个文明都居住在一座山上。建筑似乎利用山本身作为基础，而烟雾和光线都从各种各样的窗户中射出。走近一点，有一个悬崖似乎很突出。看起来龙的目标是在那里着陆。",
	"Offense is the best defense!": "进攻是最好的防守!",
	"One of the people on the cliff feels like a proper introduction is appropriate. \"We're the guardians of the vault. We've been living in this mountain for most of our lives, dedicated to protect what's inside the vault. We can't exactly say what we're guarding, but legend tells us it's defended by something created by someone more than mortal. In any case, you're welcome to enter our city, dragon rider\"": "悬崖上的一个人觉得适当的介绍是合适的。“我们是金库的守护者。我们大半辈子都住在这座山上，致力于保护保险库里的东西。我们不能确切地说我们在守卫什么，但传说它是由超越凡人的人创造的。无论如何，欢迎你进入我们的城市，龙骑士”",
	"Phew, while that smoke wasn't nearly as bad as you managed to survive in the volcano, it's still pretty nice to take a breath of cleaner air after walking down! Let's see what else is around town": "呼，虽然烟雾不像你在火山中幸存下来那么糟糕，但走下来后呼吸一下更清新的空气还是很不错的!让我们看看城里还有什么",
	"Place coal under the ceremonial fire, so it can be ignited": "把煤放在仪式用的火下面，这样它就可以点燃了",
	"Provides a full inventory of steel on completion. This reward can surpass your inventory capacity if you already hold steel": "完成时提供完整的钢材库存。这个奖励可以超过你的库存能力，如果你已经持有钢铁。",
	"Quadruples your": "四倍你的",
	"Requires coal to be present under the fire": "需要在火下面有煤",
	"Requires: 15 Wooden chip": "需要:15个木片",
	"Requires: 5 Wooden chip": "需要:5个木片",
	"Shovel molten steel right out of the furnace! There must be a safer way to obtain this...": "把熔化的钢从熔炉里铲出来!一定有更安全的方法来获得这个……",
	"Shovel some coal from the big pile they've prepared in the main square (Used to ignite fires": "从他们在主广场准备的一大堆煤里铲一些煤(用来生火的",
	"Since you don't own both of these tools yet, this may prove useful to you!": "既然你还没有这两个工具，这可能会对你有用!",
	"So many shiny things in such a small nest! But uh oh, the dog seems to have lost interest, and the crows are returning to their nest!": "这么小的窝里有这么多闪闪发光的东西!但是，哦，狗似乎已经失去了兴趣，乌鸦正在返回它们的巢!",
	"Some kids are selling a homemade slingshot. It looks pretty decent and is probably effective at shooting small objects to some height. You can't really think of a use for it at the moment though. Perhaps you'll find a use for it at a later time?": "一些孩子在卖自制的弹弓。它看起来相当不错，可能是有效的射击小物体到一定高度。不过，你现在还想不出它有什么用处。也许以后你会发现它的用处?",
	"Somehow climbing up always feels about twice as hard as climbing down. Anyhow, let's see what else is in this mountain city!": "不知怎的，往上爬总感觉比往下爬难两倍。不管怎样，让我们看看这座山城还有什么!",
	"Stone Titan": "石头泰坦",
	"Stone Titan boss fight.": "石头泰坦boss战。",
	"The blacksmith didn't seem too interested in a long conversation, but gave you some quick pointers. There are some construction blueprints on the table that you're free to use... Oh and the dog is playing with a stick that it shouldn't be playing with": "铁匠似乎对长时间的谈话不太感兴趣，但给了你一些快速的指示。桌子上有一些建筑图纸，你可以随意使用。哦，这只狗在玩一根它不应该玩的棍子",
	"The blacksmith's dog is playing with some sort of stick. It isn't supposed to, but the blacksmith didn't really seem to have the time to take it away from the dog": "铁匠的狗在玩一根棍子。这是不应该的，但铁匠似乎没有时间把它从狗那里拿走。",
	"The boss adapts to your actions, causing": "老板适应你的行为，导致",
	"The boss adapts to your actions, causing this action to become more difficult based on completed": "boss会适应你的行动，导致这个行动在完成的基础上变得更加困难",
	"The crowd actually became a little quiet, stunned by disbelief of how you've managed to defeat their strongest beast. That was believed to be impossible. At this point you're starting to scare them, and the announcer asks you to leave the arena with a tremble in the voice": "观众实际上变得有点安静，他们难以置信你是如何打败他们最强壮的野兽的。这被认为是不可能的。这时你开始吓到他们了，播音员用颤抖的声音叫你离开竞技场。",
	"The crowd is really dense now that the trade fair has started. You're welcome to join, but can't move much": "他说:交易会已经开始了，人群真的很密集。欢迎你加入，但不能移动太多。",
	"The dog charged after some birds right after you took its toy. Let's see where it leads you!": "你刚拿走它的玩具，这只狗就冲向了几只鸟。让我们看看它会把你引向何方!",
	"The dog led you to a nest of crows! They all fled as soon as the dog approached. You see some glimmering things in their nest": "这只狗把你带到乌鸦窝里!狗一靠近，他们就都逃走了。你可以在它们的巢里看到一些闪光的东西。",
	"The keepers welcome you, and get right to it. \"We've been guarding this vault for generations, without even being sure if anyone would ever prove worthy of reopening it. Legend has it that if anyone worthy ever arrived, it would be in a manner that others would consider impossible. So you understand our surprise when you flew in on the back of a greenscale. It isn't for us to judge though. The vault was created by the Architect himself, and should be able to determine for itself\"": "看守者欢迎你，快去吧。“我们几代人都在守卫着这个金库，甚至不确定是否有人值得重新打开它。传说中，如果有一个值得尊敬的人来了，他会以一种其他人认为不可能的方式到来。所以你应该能理解我们对你坐着绿鳞飞机飞来的惊讶吧。但这不是由我们来评判的。拱顶是由建筑师自己创造的，应该能够自己决定。”",
	"The people here are clearly welcoming! You didn't want to boast too much about the fact that you were the one to fly in on that dragon, but it grabbed some attention for sure. They are working on a festive fire. It's all built, but could use some coal and they'd like you to be the one to ignite it!": "这里的人显然是欢迎的!你并不想吹嘘自己是那个飞到龙身上的人，但这确实吸引了一些人的注意。他们正在生火庆祝节日。它已经建好了，但可能需要一些煤，他们想让你来点燃它!",
	"The requirement of this unlock goes down with every other completion of": "解锁的要求会随着其他任务的完成而降低。",
	"The stairs were in a pretty good state, so it wasn't too much of a climb up. Now that you're here, you see that the smoke is coming from some furnaces. It seems that they manage their production of resources here, so that the smoke doesn't cover too much of the city": "楼梯状况很好，所以爬上去不太费力。现在你在这里，你看到烟是从一些炉子里冒出来的。他们似乎在管理这里的资源生产，这样烟雾就不会覆盖太多的城市。",
	"There seems to be someone on top of the waterfall, removing debris from their water supply. That person appears to be making gestures at you, pointing at some things on top of the waterfall as well as downwards, and waving at you": "似乎有人在瀑布顶上，从他们的供水系统中清除碎片。那个人似乎在向你做手势，指着瀑布顶部和下面的一些东西，并向你招手。",
	"There's an enormous humanoid-like stone shape in the middle of the vault. Let's find out what it is": "在拱顶的中央有一个巨大的人形石头形状。让我们看看它是什么",
	"These things want you out of their nest as soon as possible and are coming at you with their entire flock. Let's see if you can scare them away like the dog did": "这些东西想让你尽快离开它们的巢，带着它们的整个羊群来找你。让我们看看你是否能像狗一样把它们吓跑。",
	"They weren't as talkative as before, clearly overwhelmed by the moment that multiple generations of their families had been waiting for. \"We don't know what awaits you inside. But you can dispose of any leftover resources here. You've proven worthy by the vault itself. I'm sure you'll manage whatever the Architect guarded inside!\"": "他们不像以前那么健谈了，显然他们被家人几代人一直在等待的那一刻淹没了。“我们不知道里面有什么在等着你。但是你可以在这里处理任何剩余的资源。金库本身已经证明了你的价值。我敢肯定，建筑师在里面看守的东西，你一定能处理好!”",
	"This beast is fast, but you've managed to hold on so far! It seems very determined in where it's bringing you. Almost as if it's done this before? In the distance, you see an enormous construction peeking through the clouds. And the dragon proceeds to fly directly to it": "这头野兽跑得很快，但你居然坚持了这么久!它似乎很确定要带你去哪里。就好像它以前做过一样?在远处，你看到一个巨大的建筑从云层中露出来。龙直接飞向它",
	"This thing is coming at you with big swings! But what doesn't hit you won't hurt you!": "这东西正朝你猛扑过来!但打不中你的东西也不会伤到你!",
	"To no surprise, you're welcomed by the local forager upon entering the shack! The shack is littered with piles of mushrooms, but you can't say you have a clue about whether or not they are edible": "毫不奇怪，你一进入小屋就受到了当地觅食者的欢迎!小屋里堆满了蘑菇，但你不能说你知道它们是否可以食用。",
	"Useful for consuming food. The blueprint says it should be closer to 5 steel, but getting the tines right proves tricky without further knowledge. Luckily nobody seems to pay enough attention to judge you": "对食用有用。蓝图上说它应该更接近5钢，但在没有进一步了解的情况下，正确的齿证明是棘手的。幸运的是，似乎没有人对你有足够的关注来评判你。",
	"Walking into the vault, you see a mostly empty room. It's enormous and even smells as if nobody has entered this room in decades. In the very center of the room there's one enormous humanoid-like stone shape. It seems like a statue, but you can't quite tell for sure": "走进金库，你看到一个几乎空无一人的房间。它很大，甚至闻起来就像几十年没人进过这个房间一样。在房间的正中央有一个巨大的人形石头形状。它看起来像一座雕像，但你不能完全确定。",
	"Well that was a nice trade fair! You feel comfortable with the trades you've been able to make. Let's see what else is around in the city!": "嗯，那是个不错的交易会!你对自己所做的交易感到满意。让我们看看城市里还有什么!",
	"Well that wasn't all that bad. The dragon safely landed on the cliff and you're able to jump right off its back! Bringing you here seems to have been its entire purpose, and it flies away almost immediately. After taking a quick moment to come to your senses, you notice that a couple of odd-looking people are staring at you": "好吧，这也不全是坏事。龙安全降落在悬崖上，你可以从它的背上跳下来!把你带到这里似乎是它的全部目的，但它几乎立刻飞走了。过了一会儿才回过神来，你注意到有几个长相奇怪的人在盯着你看。",
	"Well this crowd is packed for sure. You can't move much, but your inventory attracts some attention. It appears that they use some form of wooden chips as a currency for trade during the fair. Let's see if you can acquire something of interest!": "这里肯定挤满了人。你不能移动太多，但你的库存吸引了一些注意力。他们似乎在集市上使用某种形式的木片作为交易货币。让我们看看你是否能得到一些有趣的东西!",
	"Well, the dog does not seem obedient whatsoever... If you're going to take its stick, you might get bitten in the process. Now that you've gotten a closer look, you see that it's holding an iron stick. That doesn't seem like a proper toy for a dog": "嗯，这只狗看起来一点也不听话……如果你要接过它的棍子，你可能会在这个过程中被咬。现在你已经仔细看了，你看到它拿着一根铁棒。这看起来不像是狗狗的合适玩具。",
	"Well, you managed to take the stick from the blacksmith's dog! You can't help but feel that this dog could use some behavioral training though. Now that you did manage to take its toy, it's almost instantly distracted by some birds and starts charging after those. You have a gut feeling that following it might be a good idea": "好吧，你设法从铁匠的狗那里抢到了棍子!你不禁会觉得这只狗需要一些行为训练。既然你成功地拿走了它的玩具，它几乎立即被一些鸟类分散了注意力，并开始冲向那些鸟类。你有一种直觉，认为这样做可能是个好主意。",
	"When you're all done trading, you can exit the square to return to the entrance of the city. You'll gain access to local food sources again by leaving the crowd too": "当你完成交易后，你可以离开广场回到城市的入口。你也可以离开人群，再次获得当地的食物来源。",
	"When you're done exploring the top layer, walk back down. You do lose access to steel when you do": "当你探索完顶层后，再走下去。当你这样做的时候，你确实失去了获得钢铁的机会。",
	"You barely got a word in, the forager just kept on rambling about mushrooms. Long story short: it appears that this city within the mountain is covered with mushrooms, if you know where to look. And some of them are edible, but telling them apart takes some skill. The forager is happy to teach you!": "你几乎一句话都没说，采集者一直在喋喋不休地说着蘑菇。长话短说:如果你知道去哪里找的话，这座山中的城市似乎被蘑菇覆盖了。其中一些是可以食用的，但区分它们需要一些技巧。觅食者很乐意教你!",
	"You can keep the iron stick if you manage to take it from the dog. It increases the multiplier of your": "如果你能设法从狗那里把铁棒拿走，你就可以留着它。它增加了你的",
	"You have entered the": "你已进入",
	"You have unlocked this automation by completing this action 60 times!": "通过完成此操作60次，您已经解锁了此自动化!",
	"You've left the forager's shack. Let's find out what else is around in the lower part of the city!": "你已经离开了觅食者的小屋。让我们看看在城市的下城区还有什么!",
	"The titan started to fire arrows at you from a distance!": "泰坦开始从远处向你射箭！",
	"The vault has started to collapse!": "金库开始坍塌！",
	"The titan appears to have triggered some internal emergency-mode, causing a bright light to come from behind its chestplate": "泰坦似乎触发了某种内部紧急模式，导致它的胸甲后面发出一道亮光",
	"Completing this job removes food from your inventory until a total food value of at least 1.00 M is provided. Food that isn't available within the city is worth twice as much as its food value, due to popular demand": "完成这项工作将从您的库存中移除食物，直到提供至少 1.00 M 的总食物价值。 由于大众需求，城市内无法获得的食物价值是其食物价值的两倍",
	"Requires a slingshot to fire with enough accuracy, luckily you came prepared!": "需要弹弓才能足够准确地射击，幸运的是你有备而来！",
	"boss'": "boss的",
	"health by 1.00": "生命值1.00",
	"health by 2.50": "生命值2.50",
	"health by 3.00": "生命值3.00",
	"health by 5.00": "生命值5.00",
	"The speed of this action increases by 5.00% per completion": "每次完成此动作后速度增加 5.00%",
	"The boss adapts to your actions, causing similar actions to become more difficult with every completion of this action": "boss会适应你的行动，导致类似的行动随着这个行动的每一次完成而变得更加困难",
	"Disabling the core will create a fiery shockwave that will blast away most of what's left of the vault, any leftover resources in your carts, and will quadruple your": "禁用核心将产生一个炽热的冲击波，它会炸毁金库中剩下的大部分东西，以及你购物车中的任何剩余资源，并四倍你的",
	"Finishing this exploration completes the current Early Access content": "完成此探索完成当前的抢先体验内容",
	"You are currently in a boss fight. During boss fights, only milestones proceed the story, rather than every exploration. Beware though, bosses adapt to your approach, and you'll want to adjust accordingly. Nothing is random, but opportunities may not always be obvious either": "你目前正在boss战中。 在 boss 战中，只有里程碑会推进故事，而不是每次探索。 但要注意，boss会适应你的方法，你要相应地进行调整。 没有什么是随机的，但机会也可能并不总是显而易见的",
	"The boss' current health percentage. Bringing its health down to zero makes you win the fight! Other percentages may cause it to switch phases": "boss的当前生命值百分比。 将它的生命值降为零会让你赢得战斗！ 其他百分比可能会导致它切换阶段",
	"The current difficulty of": "",
	"combat type actions. This value resets between generations, but persist as long as you're fighting this boss.": "战斗类型动作的当前难度。 这个值会在几代人之间重置，但只要你在与这个老板战斗，它就会一直存在。",
	"dodge type actions. This value resets between generations, but persist as long as you're fighting this boss.": "闪避类型动作的当前难度。 这个值会在几代人之间重置，但只要你在与这个老板战斗，它就会一直存在。",
	"block type actions. This value resets between generations, but persist as long as you're fighting this boss.": "格挡类型动作的当前难度。 这个值会在几代人之间重置，但只要你在与这个老板战斗，它就会一直存在。",
	"This difficulty goes up with 2.50% with every completed action of the": "每完成一个动作，这个难度就会增加 2.50%",
	"This difficulty goes up with 5.00% with every completed action of the": "每完成一个动作，这个难度就会增加 5.00%",
	"This difficulty goes up with 7.50% with every completed action of the": "每完成一个动作，这个难度就会增加 7.50%",
	"combat type.": "战斗类型",
	"dodge type.": "闪避类型",
	"block type.": "格挡类型",
	"The vault itself": "金库本身",
	"The speed of this action increases by 1.00% per completion": "每次完成此动作的速度增加 1.00%",
	"The speed of this action decreases by 0.75% per completion": "每次完成此动作的速度降低 0.75%",
	"Recovers 0.10% of the boss' health per completion": "每次完成恢复boss的生命值 0.10%",
	"Completion damage": "完成伤害",
	"Determines the damage taken on completion (not failure) of explorations, jobs and hostile actions": "决定在探索、工作和敌对行动完成（不包括失败）时受到的伤害",
	"inventory capacity by 10. If you manage to catch it intact, you can keep it!": "库存容量增加 10。如果你设法完好无损地抓住它，你可以保留它！",
	"inventory capacity by 5. If you manage to catch it intact, you can keep it!": "库存容量增加 5。如果你设法完好无损地抓住它，你可以保留它！",
	"Invalid save code": "无效保存代码 ",
	", are you sure you've pasted the entire savecode correctly?": "你确定你已经正确粘贴了整个保存代码吗",
	"New skill unlocked!": "新技能解锁！",
	"You have unlocked the": "你解锁了",
	"Hourglass skill. This skill allows you to obtain new bonuses, some of which persist between generations. But it requires other pieces to be found in the world to obtain full power": "沙漏技能。此技能可让您获得新的奖励，其中一些奖励会代代相传。 但它需要在世界上找到其他碎片才能获得完整的力量",
	"North island discovered!": "北岛被发现！",
	"By fully exploring this island for the first time, you have unlocked the north island. But that somehow affected your instincts as well. Your next generations are now also able to proceed directly to that island, without needing to explore this island first!": "通过首次全面探索这个岛屿，您已经解锁了北岛。 但这不知何故也影响了你的直觉。 您的下一代现在也可以直接前往该岛，而无需先探索该岛！",
	"New hourglass artifact discovered!": "新沙漏神器被发现！",
	"You have discovered a new artifact that your hourglass responds to. This permanently increases the discovery multiplier of your": "你发现了一个你的沙漏会响应的新神器。 这会永久增加您",
	"hourglass skill by 0.1 and allows you to obtain a new permanent bonus": "沙漏技能的发现乘数 0.1，并让你获得新的永久奖励",
	"East island discovered!": "东岛被发现！",
	"By fully exploring this island for the first time, you have unlocked the east island. But that somehow affected your instincts as well. Your next generations are now also able to proceed directly to that island, without needing to explore either of the other islands first!": "通过首次全面探索这个岛屿，您已经解锁了东岛。 但这不知何故也影响了你的直觉。 您的下一代现在也可以直接前往该岛，而无需先探索其他岛！",
	"Volcano island discovered!": "火山岛被发现！",
	"By fully exploring this island for the first time, you have unlocked the volcano island. That somehow affected your instincts as well. Your next generations are now also able to proceed to volcano island after exploring two of the other islands. You can still choose to clear all three, but keep in mind that they each triple your health decay": "通过首次全面探索这个岛屿，您已经解锁了火山岛。 这也以某种方式影响了你的直觉。 在探索了其他两个岛屿之后，您的下一代现在也可以前往火山岛。 你仍然可以选择清除所有三个岛屿，但请记住，它们每个都会使你的健康衰减增加三倍",
	"You've entered your first": "你已经进入了你的第一个",
	"boss fight!": "boss战",
	"Unlike regular explorations, boss fights progress by bringing the boss' health down. Beware though, bosses adapt to your approach, and you'll want to adjust accordingly. Nothing is random, but opportunities may not always be obvious either": "与常规探索不同，boss 战进度通过降低 boss 的生命值来推进。 但要注意，boss会适应你的方法，你会想要相应地进行调整。 没有什么是随机的，但机会也可能并不总是显而易见的",
	"hostile action!": "敌对行动！",
	"Uh oh, a": "呃哦，一个",
	"The titan has started taking fire at you from a distance! A new action column has appeared above your inventory. Unlike other actions, you're not the one in charge when it comes to these actions. The enemy is. They automatically progress when time passes, and don't provide experience. Make sure to keep an eye on them to keep an edge over your opponent!": "泰坦已经开始从远处向你开火！ 您的库存上方出现了一个新的操作栏。 与其他行动不同，当涉及到这些行动时，您不是负责人。 敌人是。 随着时间的流逝，它们会自动进步，并且不提供经验。 一定要留意他们，以保持对对手的优势！",
	"Unlike other actions, you're not the one in charge when it comes to these actions. The enemy is. They automatically progress when time passes, and don't provide experience. Make sure to keep an eye on them to keep an edge over your opponent!": "与其他行动不同，当涉及到这些行动时，您不是负责人。 敌人是。 随着时间的流逝，它们会自动进步，并且不提供经验。 一定要留意他们，以保持对对手的优势！",
	"Lowers the damage taken on completion (not failure) of explorations, jobs and hostile actions by 5% per perk tier": "每级使探索、工作和敌对行动完成（不包括失败）时受到的伤害降低 5%",
	"points are only earned for full completions of current content. Restarting new game+ is not advised unless you changed your mind about your chosen perks early in a playthrough, or you have another reason to want to restart from the beginning": "只有完全完成当前内容才能获得点数。 不建议重新开始新游戏+，除非您在游戏初期改变了对所选特权的想法，或者您有其他理由想要从头开始重新开始",
	"Warning: New game+": "警告：新游戏+",
	"Available and total DNA earned by completing the game. DNA is only awarded for full completions of currently available content, and the reward scales with chapter releases (10 DNA per chapter, upon full completion of currently available content": "通过完成游戏获得的可用 DNA 和总 DNA。 DNA 仅在完全完成当前可用内容时奖励，并且奖励随着章节发布而增加（每章 10 DNA，在完全完成当前可用内容后",
	"Generation information about your new game+ status": "关于您的新游戏+状态的生成信息",
	"The perks you've selected for this new game+ playthrough": "您为这个新游戏+游戏选择的额外特权",
	"Current playthrough": "当前游戏",
	"Last playthrough": "上次游戏",
	"Not yet completed": "尚未完成",
	"If a more frequent option is chosen, less frequent options trigger as well": "如果选择更频繁的选项，则不那么频繁的选项也会触发",
	"Please be absolutely sure before hitting this button, data can not be recovered after you've wiped your save (except for a manual export": "请在点击此按钮之前绝对确定，擦除保存后无法恢复数据（手动导出除外",
	"Warning: Wiping your save resets your new game+ progression as well. You might want to restart new game+ instead": "警告：擦除您的保存也会重置您的新游戏+进程。 您可能想重新启动新游戏+",
	"Previous records": "以往记录",
	"Restart generation": "重新开始这一代",
    "Missing some data": "缺少一些数据",
    "It appears that your save is from before this options was introduced (June 2023), and is therefore missing some required data. This option should become available after your next reincarnation!": "您的保存似乎是在引入此选项之前（2023 年 6 月），因此缺少一些必需的数据。 这个选项应该在你下次转世后可用！",
    "7 June 2023": "2023年6月7日",
    "Are you sure you want to restart this generation?": "您确定要重新开始这一代吗？",
    "Auto unpause on restart": "重新开始时自动取消暂停",
    "Both": "两个都显示",
    "Don't override": "不要覆盖",
    "Extra pause button": "额外的暂停按钮",
    "Instinct display": "本能展示方式",
    "Level (+Increase": "等级(+增加",
    "Lower by  one priority tier": "降低  一个优先级",
	"Lower by  two priority tiers": "降低  两个优先级",
	"Lower by  three priority tiers": "降低  三个优先级",
	"Lower to  regular priority": "降低到  常规优先级",
	"Lower to  high priority": "降低到  高优先级",
	"Lower to  low priority": "降低到  低优先级",
	"Disable automation ": "禁用自动化 ",
	"Multiplier  New multiplier": "乘数  新乘数",
	"a priority lowers automations to the specified setting, unless the job is already configured to a lower priority.": "优先级将自动化降低到指定的设置，除非作业已配置为较低的优先级。",
	"Adds an additional pause button to the top of the queue. Mainly for players that exclusively play with their mouse, and dislike the pause button moving up and down when the queue changes size": "在队列顶部添加一个额外的暂停按钮。 主要针对只用鼠标玩的玩家，不喜欢队列大小改变时暂停按钮上下移动",
	"Adds instinct levels gained during the current generation to the skill tooltips": "将当前世代获得的本能水平添加到技能工具提示中",
	"Override exhausted": "覆盖耗尽",
	"Exhausted jobs refer to cooking jobs, when their required resource-job is no longer available, but you still have some of those resources left.": "耗尽的工作是指烹饪工作，当他们所需的资源工作不再可用时，但您仍然有一些资源剩余。",
	"If you're not specifically looking for this feature, using it is not recommend until you're very familiar with the automation system": "如果您不是专门寻找此功能，则在您非常熟悉自动化系统之前不建议使用它",
	"Notification volume": "通知音量",
	"Configure the volume for the sound notification": "配置声音通知的音量",
	"Restarting this generation causes you to lose all progress obtained throughout this generation, including instinct experience and automation unlocks progress": "重新开始这一代会导致你失去这一代获得的所有进度，包括本能经验和自动化解锁进度",
	"While not necessary to progress at all, some players want to min-max to a degree where adjusting automation priorities mid-run helps. This setting aims to reduce manual repetition for those players, by automatically (temporarily) overriding priorities.": "虽然根本没有必要改进，但一些玩家希望最小-最大程度达到在运行中调整自动化优先级有帮助的程度。 此设置旨在通过自动（暂时）覆盖优先级来减少这些玩家的手动重复。",
	"Tooltip instinct gain": "工具提示本能增益",
	"Using this feature isn't generally advised, but can be used if you feel like you've made a grave mistake that you want to undo during this generation. This is aimed for players that are aiming for impressive completion times, but isn't worth the trouble of re-doing a generation for the majority of players": "通常不建议使用此功能，但如果您觉得自己犯了一个严重的错误并且想在这一代中撤消，则可以使用此功能。 这是针对那些追求令人印象深刻的完成时间的玩家，但不值得为大多数玩家重新做一代的麻烦",
	"Setting specifics: Lowering": "设置细节：",
	"by": "降低",
	"an amount of tiers reduces automation based on your current automation setting, minus the setting. Down to a minimum of disabled (ex: high > low would refer to two tiers, high > off would be three tiers). Lowering": "一定数量的层级会根据您当前的自动化设置减去设置来降低自动化程度。降低到最低限度的禁用（例如：高>低表示两层，高>关闭表示三层）。 ",
	"to": "降低到",
...
var cnPrefix = {
    ...
    "Discovery multiplier: ": "发现乘数：",
    "Funnel tooth completions: ": "注入齿完成：",
    "Funnel shield completions: ": "注入护盾完成：",
    "Funnel hourglass completions: ": "注入沙漏完成：",
    "Funnel titan core completions: ": "注入泰坦核心完成：",
    "health decay will increase by ": "生命值衰减会增加 ",
    "health decay remains the same  |  ": "生命值衰减保持不变 | ",
    "Health decay × ": "生命值衰减 × ",
    "Story multiplier:": "故事乘数:",
	"Digging skill, but": "挖掘技能，但是",
	"Hunting skill, but": "狩猎技能，但是",
	"Agility skill, but": "敏捷技能，但是",
	"Sailing skill, but": "航行技能，但是",
	"Hourglass skill, but": "沙漏技能，但是",
	"Combat skill, but": "战斗技能，但是",
	"Woodcutting skill, but": "伐木技能，但是",
	"Cooking skill, but": "烹饪技能，但是",
	"Social skill, but": "社交技能，但是",
	"Farming skill, but": "农业技能，但是",
	"Fishing skill, but": "钓鱼技能，但是",
	"Construction skill": "建造技能",
	"Digging skill": "挖掘技能",
	"Hunting skill": "狩猎技能",
	"Agility skill": "敏捷技能",
	"Sailing skill": "航行技能",
	"Hourglass skill": "沙漏技能",
	"Combat skill": "战斗技能",
	"Woodcutting skill": "伐木技能",
	"Cooking skill": "烹饪技能",
	"Social skill": "社交技能",
...
var cnRegReplace = new Map([
    ...
    [/^([\d\.]+)d ([\d\.]+)h ([\d\.]+)m$/, '$1天 $2时 $3分'],
    [/^. Resources required stay the same, but aren\'t all required at once  \|  (.+) $/, '。 所需资源保持不变，但并非一次性全部需要 \| $1 '],
    [/^. Resources required stay the same, but aren\'t all required at once$/, '。 所需资源保持不变，但并非一次性全部需要'],
	...
	// [/^Social skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "社交技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Agility skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "敏捷技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Hunting skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "狩猎技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Farming skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "农业技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Sailing skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "航行技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Woodcutting skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "伐木技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Digging skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "挖掘技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Fishing skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "钓鱼技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Construction skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "建造技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Hourglass skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "沙漏技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Cooking skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "烹饪技能乘数 $1 成功，如果你的乘数较低则失败"],
	// [/^Combat skill multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "战斗技能乘数 $1 成功，如果你的乘数较低则失败"],
	[/^ multiplier of ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) to succeed, and fails if your multiplier is lower$/, "乘数 $1 成功，如果你的乘数较低则失败"],
	...
	[/^Chapter ([\d\.]+)$/, '章节 $1'],
    // [/^Construction skill  \|  (.+) exp$/, '建造技能  \| $1 经验值'],
    ...
    // [/^Combat skill  \|  (.+) exp$/, '战斗技能  \| $1 经验值'],
    // [/^Hourglass skill  \|  (.+) exp$/, '沙漏技能  \| $1 经验值'],
    [/^(.+) \/ (.+)  \|  (.+) exp$/, '$1 \/ $2  \| $3 经验值'],
...
//    [/^(.+) health when eaten$/, '食用时恢复 $1 生命值'],
    ...
    [/^([\d\.]+)e([\d\.,]+) elves$/, '$1e$2 精灵'],
    [/^([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health at once$/, '$1 生命值立刻'],
    [/^([\d\.,]+) elves$/, '$1 精灵'],
    [/^\*(.+) to electricity gain$/, '\*$1 到电力增益'],
    [/^Requires: (.+) Raw shark, (.+) Dead pelican, (.+) Vegetable$/, '需要：$1 生鲨鱼, $2 死鹈鹕，$3 蔬菜'],
    ...
    [/^Requires: (.+) Steel$/, '需要：$1 钢'],
    [/^Requires: (.+) Coal lump$/, '需要：$1 煤块'],
    [/^Requires: (.+) Wooden chip$/, '需要：$1 木片'],
    ...
    [/^Requires: (.+) Moldy wood, (.+) Titan stone$/, '需要：$1 发霉的木头, $2 泰坦石'],
    [/^Cost: (.+) points$/, '成本：$1 点数'],
    [/^Costs: ([\d\.,]+)$/, '成本：$1'],
    [/^Req: (.+) \/ (.+) elves$/, '成本：$1 \/ $2 精灵'],
    [/^Usages: (\d+)\/$/, '用途：$1\/'],
    [/^workers: (\d+)\/$/, '工人：$1\/'],
	[/\(tier: (\d+)$/, '(等级: $1'],
    [/^Tier: (\d+)  \|  Total allocated: ([\d\.,]+)$/, '等级: $1 |  总计: $2'],
    [/^ \|  Total allocated: ([\d\.,]+)$/, ' |  总计: $1'],
    [/^Tier: (\d+)  \|  Previous cost: ([\d\.,]+)$/, '等级: $1 |  上一级: $2'],
	[/^These beasts may look harmless, but they definitely aren't. Every completion causes ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) damage, reduces all active food cooldowns by 10% of your maximum cooldown, and provides 1 raw seal per completion \(Can be cooked/, "这些野兽可能看起来无害，但绝对不是。 每次完成都会造成 $1 伤害，基于最大冷却时间的 10% 减少所有可用的食物冷却时间，并且每次完成提供 1 个生海豹（可以烹饪"],
	[/^Very hot. Every completion causes ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) damage, reduces all active food cooldowns by 10% of your maximum cooldown, and provides 1 magma block per completion \(Used for construction/, "很烫。每次完成造成 $1 伤害，基于最大冷却时间的 10% 减少所有可用的食物冷却时间，并且每次完成提供 1 个熔岩块（用于建造"],
	[/Every completion causes ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) damage, reduces all active food cooldowns by 10% of your maximum cooldown, and provides 1 steel per completion \(Used for construction/, "每次完成造成 $1 伤害，基于最大冷却时间的 10% 减少所有可用的食物冷却时间，并且每次完成提供 1 钢（用于建造"],
	[/You've successfully fired (\d+) \/ (\d+) times at the titan so far$/, "到目前为止，您已成功向泰坦开火 $1 \/ $2 次"],
	[/You have completed (\d+) actions of this type during your current fight$/, "您在当前战斗中已完成 $1 次此类操作"],
	[/Deals ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) damage per completion$/, "每次完成造成 $1 伤害"],
	[/\(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) uncooked$/, "(+$1 未煮熟"],
	
	[/You have unlocked this automation by completing this action (\d+) times!$/, "您已通过完成此操作 $1 次来解锁此自动化！"],

	[/Passively completes every ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) seconds$/, "每 $1 秒被动完成一次"],
	[/Passively completes ([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) times per second$/, "每秒被动完成 $1 次"],
	[/^Health can be restored by eating food, which is automatically consumed up to once every ([\d\.,]+) seconds per type of food. Food is only consumed if your health becomes low enough to gain the maximum health value of the food, or if eating would prevent death$/, "吃食物可以恢复生命值，每种食物每 $1 秒自动消耗一次。 仅当您的生命值状况变得低到足以获得食物的最大生命值价值，或者如果进食可以防止死亡时，才会食用食物"],
	[/^This is how fast your health declines \(per second\). This value increases by ([\d\.,]+)% per minute that this generation is alive$/, "这是您的生命值下降的速度（每秒）。 此值每分钟增加 $1%，这世代还活着"],
	[/^This increase is compounding, so it increases ([\d\.,]+) > ([\d\.,]+) > ([\d\.,]+) > ([\d\.,]+) > ([\d\.,]+) during the first four minutes \(actual values can be affected by constructions$/, "这种增加是复利的，因此在前四分钟内增加了 $1 > $2 > $3 > $4 > $5（实际值可能会受到结构的影响"],
	[/^Health decay increases by ([\d\.,]+)% per minute, based on the current amount. Because of that, there is no downside to finishing this early.$/, "生命值衰减每分钟增加 $1%，基于当前数量。 正因为如此，早点完成并没有什么坏处。"],

	[/^Provides 1 berry per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten/, "每次完成提供 1 个浆果（食用时 +$1 生命值"],
	[/^Cooks 1 fish per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a raw fish to cook/, "每次完成烹饪 1 条鱼（食用时 +$1 生命值），需要生鱼来烹饪"],
	[/^Provides 1 apple per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten/, "每次完成提供 1 个苹果（食用时 +$1 生命值"],
	[/^Cooks 1 rabbit per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a dead rabbit to cook/, "每次完成烹饪 1 只兔子（食用时 +$1 生命值），需要死兔子来烹饪"],
	[/^Provides 1 herring per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten/, "每次完成提供 1 条鲱鱼（食用时 +$1 生命值"],
	[/^Bakes 1 bread per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a grain to bake/, "每次完成烘焙 1 个面包（食用时 +$1 生命值），需要谷物来烘焙"],
	[/^Bakes 1 cake per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a grain to bake/, "每次完成烘焙 1 个蛋糕（食用时 +$1 生命值），需要谷物来烘焙"],
	[/^Cooks 1 boar per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a dead boar to cook/, "每次完成烹饪 1 头野猪（食用时 +$1 生命值），需要死掉的野猪来烹饪"],
	[/^Cooks 1 crab per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a raw crab to cook/, "每次完成烹饪 1 只螃蟹（食用时 +$1 生命值），需要生螃蟹来烹饪"],
	[/^Shake tree, catch what falls out! Provides 1 coconut per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten/, "摇树，抓住掉下来的东西！ 每次完成提供 1 个椰子（食用时 +$1 生命值"],
	[/^Provides 1 banana per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten/, "每次完成提供 1 个香蕉（食用时 +$1 生命值"],
	[/^Cooks 1 goat per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a dead goat to cook/, "每次完成烹饪 1 只山羊（食用时 +$1 生命值），需要死山羊来烹饪"],
	[/^Cooks 1 vulture per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a raw vulture to cook/, "每次完成烹饪 1 只秃鹰（食用时 +$1 生命值），需要生秃鹰来烹饪"],
	[/^Provides 1 moss per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), full of vitamins and .. flavors/, "每次完成提供 1 个苔藓（食用时 +$1 生命值），富含维生素和 .. 风味"],
	[/^Cooks 1 eel per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a raw eel to cook/, "每次完成烹饪 1 条鳗鱼（食用时 +$1 生命值），需要生鳗鱼来烹饪"],
	[/^Provides 1 orange per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten/, "每次完成提供 1 个橙子（食用时 +$1 生命值"],
	[/^Bakes 1 biscuit per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires dough to bake/, "每次完成烘焙 1 条鳗鱼（食用时 +$1 生命值），需要面团来烘焙"],
	[/^Cooks 1 lobster per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a raw lobster to cook/, "每次完成烹饪 1 只龙虾（食用时 +$1 生命值），需要生龙虾来烹饪"],
	[/^Bakes 1 pie per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires dough to bake/, "每次完成烘焙 1 个馅饼（食用时 +$1 生命值），需要面团来烘焙"],
	[/^Provides 1 tomato per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten/, "每次完成提供 1 个番茄（食用时 +$1 生命值"],
	[/^Cooks 1 shark per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a raw shark to cook/, "每次完成烹饪 1 条鲨鱼（食用时 +$1 生命值），需要生鲨鱼来烹饪"],
	[/^Cooks 1 pelican per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a dead pelican to cook. Tastes surprisingly close to fish, for a bird/, "每次完成烹饪 1 只鹈鹕（食用时 +$1 生命值），需要死鹈鹕来烹饪。对鸟来说，味道惊人地接近鱼"],
	[/^Cooks 1 portion of soup per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when drunk\). You already put all the ingredients in the pot! Only available in camp/, "每次完成煮 1 份汤（喝下时 +$1 生命值）。你已经把所有的原料都放进锅里了！仅在营地可用"],
	[/^Gives you 1 portion of stew per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when consumed\). It's gray and has some bean-like things in it. Fishing out the parts that seem somewhat edible takes some effort. Best eaten with nose closed/, "每次完成给你 1 份炖肉（消耗时 +$1 生命值）。它是灰色的，里面有一些类似豆子的东西。捞出看起来有些可食用的部分需要一些努力。最好闭着鼻子吃"],
	[/^Cooks 1 piece of bull meat per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires bull meat to cook/, "每次完成烹饪 1 块牛肉（食用时 +$1 生命值），需要牛肉来烹饪"],
	[/^Cooks 1 falcon per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a dead falcon to cook/, "每次完成烹饪 1 只猎鹰（食用时 +$1 生命值），需要死猎鹰来烹饪"],
	[/^Cooks 1 seal per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a raw seal to cook/, "每次完成烹饪 1 个海豹（食用时 +$1 生命值），需要生海豹来烹饪"],
	[/^Provides 1 corncob per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten/, "每次完成提供 1 根玉米（食用时 +$1 生命值"],
	[/^Provides 1 edible mushroom per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten/, "每次完成提供 1 个可食用蘑菇（食用时 +$1 生命值"],
	[/^Cooks 1 koi carp per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a raw koi carp to cook/, "每次完成烹饪 1 条锦鲤（食用时 +$1 生命值），需要生锦鲤来烹饪"],
	[/^Spend two wooden chips to buy a mixed salad \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), filled with five types of fruit and lettuce!/, "花两块木片买一份混合沙拉（食用时 +$1 生命值），里面有五种水果和生菜！"],
	[/^Spend five wooden chips to buy a packed meal \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), contains all major food groups!/, "花五个木片买一份盒饭（食用时 +$1 生命值），包含所有主要食物组！"],
	[/^Cooks 1 gollum clam per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\), requires a gollum clam to cook/, "每次完成烹饪 1 个咕噜蛤蜊（食用时 +$1 生命值），需要咕噜蛤蜊来烹饪"],
	[/^Provides 1 portion of honey per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten/, "每次完成提供 1 份蜂蜜（食用时 +$1 生命值"],
	[/Provides 1 portobello mushroom per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\). Luckily you've had some mushroom training, so you know which ones to gather!/, "每次完成提供 1 个双孢蘑菇（食用时 +$1 生命值）。幸运的是你接受过一些蘑菇训练，所以你知道该采哪些蘑菇！"],
	[/Provides 1 portobello mushroom per completion \(\+([\d\.]+(?:(?: [K|M|B|T|Qa])|(?:e(?:[\d\.,]+)))?) health when eaten\). If only you would have had some mushroom training. You can't really tell which ones to gather, so let's play it safe and not gather them for now/, "每次完成提供 1 个双孢蘑菇（食用时 +$1 生命值）。要是你能接受一些蘑菇训练就好了。 你真的不知道要收集哪些，所以让我们谨慎行事，暂时不要收集它们"],
]);
