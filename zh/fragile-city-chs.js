...
var cnItems = {
    ...
    "education": "教育",
    "Education buildings will, once a year, move citizens up an education level. This allows them to work at buildings with higher job levels, and make more money (and you, too, through taxes!": "教育建筑将每年一次提升市民的教育水平。 这使他们可以在工作级别更高的建筑物中工作，并赚更多的钱（您也可以通过税收赚更多的钱！",
    "Energy buildings produce energy when they're operational. Energy is required to operate most other buildings. You need citizens to operate most of the energy buildings.": "能源建筑在运行时会产生能源。 大多数其他建筑物的运行都需要能源。 您需要市民来操作大部分能源建筑。",
    "entertainment": "娱乐",
    ...
    "hospitals": "医院",
    "housing": "住房",
    "Housing is required to retain citizens — otherwise, they'll die. Housing requires energy and area; if you run out of energy, you might run out of housing rather quickly!": "需要住房来留住市民——否则，他们就会死去。 住房需要能源和面积； 如果你用完了能量，你可能很快就会用完房子！",
    "huts": "小屋",
    "libraries": "图书馆",
...
var cnRegReplace = new Map([
    ...
    [/^\n(.+) \(edu lvl (\d+)\) moved to (.+)$/, '\n$1（教育等级 $2）搬到了 $3'],
    [/^\n(.+) \(edu lvl (\d+)\) has died because of old age. RIP$/, '\n$1（教育等级 $2）因年老而死。 安息吧'],
