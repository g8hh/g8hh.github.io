// ==UserScript==
// @name         Raven Quest 简中汉化脚本
// @namespace    https://www.g8hh.com.cn/
// @version      0.0.1
// @description  网页游戏 Raven Quest (https://ravenquest.io) 的简体中文汉化脚本。Simplified Chinese i18n script for web game Raven Quest.
// @author       好阳光的小锅巴 & 麦子
// @copyright    锅巴汉化
// @contributionUR    https://gityx.com/donate/intro.html
// @icon         https://cdn.ravenquest.io/assets/favicon-CIeUaANU.ico
// @license      MIT
// @include      *https://ravenquest.io*
// @grant        none
// @website      https://www.gityx.com/
// @updateURL    https://g8hh.com.cn/zh/tampermonkey/raven-quest-chs.user.js
// @downloadURL    https://g8hh.com.cn/zh/tampermonkey/raven-quest-chs.user.js
// ==/UserScript==
/**
 * ---------------------------
...
var cnItems = {
    ...
    "Mute": "静音",
    "Unmute": "播放",
    "Account created successfully. Please check your inbox to confirm your account.": "帐号创建成功。请检查您的邮箱收件箱以确认您的帐户。",
    "EN": "英",
    "EN - English": "英 - 英语",
    "Home": "首页",
    "HOME": "首页",
    ...
    "PT - Portuguese": "葡 - 葡萄牙语",
    "©2025 Tavernlight Games. All rights reserved. All trademarks referenced here are the properties of their respective owners.": "©2025 Tavernlight Games。版权所有。此处引用的所有商标均为其各自所有者的财产。",
    "and enjoy these exclusive rewards": "并享受这些专属奖励",
    "Discord Badge": "不和谐徽章",
    "Email Address\n": "电子邮件地址\n",
    "Exclusive Companion": "专属伴侣",
    "Exclusive Teasers & Events": "专属预告和活动",
    "For other issues, email us at": "其他问题，请发送电子邮件至",
    "Get Your Free Perks": "领取免费福利",
    "I did not receive an email to validate my account": "我没有收到验证账号的邮件",
    "I forgot my password": "我忘了密码",
    "If you have enabled Two-Factor Authentication on your account, please provide your two-factor code.": "如果您的帐户已启用双因素身份验证，请提供您的双因素密码。",
    "MEDIA KIT": "媒体资料包",
    "News": "新闻",
    "NEWS": "新闻",
    "Password\n": "密码\n",
    "Ravenquest": "渡鸦任务",
    "Register a new account": "注册一个新帐户",
    "Start Your Adventure!": "开始你的冒险吧！",
    "support@ravenquest.io": "support@ravenquest.io",
    "Trouble signing in?": "登录时遇到麻烦？",
    "Two-Factor (optional)\n": "双因子（可选）\n",
    "Whitepaper": "白皮书",
    "and": "和",
    "apply.": "适用。",
    "Email\n": "电子邮件\n",
    "Google Privacy Policy": "谷歌隐私政策",
    "If for some reason your verification email did not arrive you can request a new one here.": "如果由于某种原因你的验证邮件没有到达，你可以在这里申请一个新的。",
    "Please enter your account email address using the form below:": "请使用以下表格输入您的帐户电邮地址：",
    "Recover": "恢复",
    "Send email verification": "发送邮件验证",
    "Terms of Service": "服务条款",
    "This page is protected by reCAPTCHA and the": "此页面受reCAPTCHA和",
    "If the details provided are correct you will receive an email from us. Please check your inbox!": "如果提供的详细信息正确，您将收到我们的电子邮件。请检查你的收件箱！",
    "Account confirmed successfully. Thank You!": "帐户确认成功，您现在可以登录了。非常感谢！",
    "The Referral System is a system that rewards you for sharing RavenQuest to your friends! You can customize your Referral the way you want and start inviting friends to join through your invite link.": "推荐系统是一个奖励你向朋友分享RavenQuest的系统！你可以自定义你的推荐方式，并通过你的邀请链接开始邀请朋友加入。",
    "": "",
    "": "",
    "": "",
    "": "",
