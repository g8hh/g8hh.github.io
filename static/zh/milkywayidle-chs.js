...
var cnItems = {
    ...
    "Excelsa Coffee Bean": "艾克莎咖啡豆",
    "Expire Time": "过期时间",
    "Eye": "眼睛",
    "Eyes": "眼睛",
    "Farmland": "农田",
    "Fate": "命运",
    "Fieriosa Coffee Bean": "菲里奥萨 咖啡豆",
    "Fight": "斗争",
    "Fighting": "斗争",
    "Fly": "苍蝇",
    "Food": "食物",
    ...
    "Status": "状态",
    "still think early levels are too easy": "仍然认为早期的等级太容易了",
    "Strawberry": "草莓",
    ...
    "Smashy": "粉碎者",
    "Stabby": "刺杀者",
    "The hardened cheeses made with milks from the magical cows are as tough as metal. You can smith them into equipment that gives you bonuses in combat or skilling.": "用神奇奶牛的牛奶制成的硬化奶酪像金属一样坚韧。 您可以将它们锻造成装备，为您提供战斗或技能奖励。",
    "Hands": "手部",
    "Gummy Bear": "软糖小熊",
    "Feet": "脚部",
    "Equipment is upgradable from one tier to the next, often requiring increasing amount of cheese. There is also special equipment that can be crafted with items found from monsters in combat.": "装备可以从一层升级到下一层，通常需要越来越多的奶酪。 还有一些特殊装备可以用在战斗中从怪物身上找到的物品来制作。",
    "Equipping a hammer will boost your cheesesmithing skill.": "装备一把锤子会提高你的奶酪制作技能。",
    "Cows love to be brushed. Equipping a brush will boost your milking skill.": "奶牛喜欢被刷毛。 装备刷子将提高您的挤奶技能。",
    "The milks from these magical cows have a wide variety of functions. They can be used to produce consumables or craft into special cheese to make equipment.": "这些神奇奶牛的牛奶具有多种功能。 它们可用于生产消耗品或加工成特殊的奶酪来制造装备。",
    "You can find many different resources while foraging in the various areas. These resources can be used for cooking and brewing consumables.": "在各个区域觅食时，您可以找到许多不同的资源。 这些资源可用于烹饪和酿造消耗品。",
    "Equipping shears will boost your foraging skill.": "装备剪刀会提高你的觅食技巧。",
    "Exp to Level Up": "升级经验",
    "Equipping a spatula will boost your cooking skill.": "配备抹刀会提高你的烹饪技巧。",
    "Azure Cow": "蔚蓝奶牛",
    "Heal Over Time": "随着时间的推移治愈",
    "The art of making healthy food.": "制作健康食品的艺术。",
    "The art of making tasty drinks.": "制作美味饮品的艺术。",
    "Abilities can be learned from ability books. You can acquire ability books as drops from monsters or purchase them from other players in the marketplace.": "技能可以从技能书上学习。 您可以从怪物身上获得技能书，也可以从市场上的其他玩家那里购买。",
    "Abilities can be placed into slots to be used in combat. You unlock more slots as your intelligence skill level increases.": "可以将技能放入插槽中以在战斗中使用。 随着智力等级的提高，您可以解锁更多插槽。",
    "Abilities can level up as you gain experience. You get 0.1 experience for every use in combat and a much larger amount from consuming duplicate ability books": "能力可以随着经验的增加而升级。 每次在战斗中使用可以获得 0.1 经验，而消耗重复的技能书则获得更多经验",
    "Drinks can provide you with temporary buffs. Coffee can be brought with you to combat and tea(coming soon) can be used while skilling.": "饮料可以为您提供暂时的增益。 咖啡可以带上战斗，茶（即将推出）可以在技能时使用。",
    "Enhancing allows you to permanently improve your equipment, giving them increasing bonuses as their enhancement level go up.": "强化可以让你永久地改进你的装备，随着强化等级的提高，他们会获得越来越多的奖励。",
    "Enhancing costs a small amount of materials for each attempt.": "每次尝试的增强都会消耗少量材料。",
    "Equipping a pot will boost your brewing skill.": "装备一个锅将提高你的酿造技巧。",
    "Equipping an enhancer will boost your enhancing skill.": "装备增强器将提高您的增强技能。",
    "Doing nothing ...": "什么都没做...",
    "Kek cow": "凯克牛",
    "Total Experience": "总经验",
    "Fighting monsters will earn you experience and item drops.": "与怪物战斗将为您赢得经验和物品掉落。",
    "Drop Rate: Increase item drop rate": "掉落率：提高物品掉落率",
    "Did you know you can craft equipment using these special hardened cheeses?": "您知道您可以使用这些特殊的硬化奶酪制作设备吗？",
    "Hit Chance = (MyAccuracy^1.4) / (MyAccuracy^1.4 + EnemyEvasion^": "命中几率 = (我的精准^1.4) / (我的精准^1.4 + 敌人闪避^",
    "HP Regen: +": "生命恢复：+",
    "HP Regen: Recover % of Max HP per": "生命值恢复：每次恢复 % 最大 生命值",
    "Max HP = 10 * (10 + Stamina": "最大生命值 = 10 * (10 + 耐力",
    "Max MP = 10 * (10 + Intelligence": "最大 法力 = 10 * (10 + 智力",
    "Recover % of Max MP per": "每次恢复 % 最大 法力",
    "You can bring food to recover HP or MP, drinks to give you buffs, and abilities that can be cast. You can change the automation configuration from the settings icon below them.": "你可以带食物来恢复HP或MP，带饮料来给你增益，以及可以施放的能力。 您可以从它们下方的设置图标更改自动化配置。",
    "You can optionally consume a copy of the base equipment during each attempt for protection. Failure with protection will only reduce the enhancement level by 1.": "您可以选择在每次尝试保护时使用基础设备的副本。 保护失败只会将增强级别降低1。",
    "Your combat stats are based on a combination of your combat skill levels and your equipment bonuses.": "您的战斗统计数据基于您的战斗技能等级和您的装备奖励的组合。",
    "Total Level": "总等级",
    "Rank": "排名",
    "Name": "名称",
    "Food Slots": "食物插槽",
    "Drink Slots": "饮料插槽",
    "Evasion = (10 + Defense) * (1 + %bonus": "闪避 = (10 + 防御) * (1 + %奖励",
    "unlimited": "无限",
    "Stop": "停止",
    "Start": "开始",
    "Two Hand": "双手",
    "Lvl": "等级",
    "Ability Book": "能力书",
    "Ability Exp Per Book": "每本书的能力经验",
    "Cleave": "分裂",
    "Crab Pincer": "蟹钳",
    "Effect: Increases accuracy by 25% for": "效果：提高25%的命中率",
    "Effect: Increases armor by 30 for": "效果：护甲增加30",
    "Effect: Increases attack speed by 25% for": "效果：攻击速度提高25%",
    "Effect: Increases damage by 25% for": "效果：伤害增加25%",
    "Effect: Slashs all enemies for 20 HP + 30% auto attack damage": "效果：斩击所有敌人，造成 20 生命值 + 30% 自动攻击伤害",
    "Effect: Slashs enemy for 20 HP + 35% auto attack damage and bleeds for 200% dealt damage over": "效果：斩击敌人造成 20 生命值 + 35% 自动攻击伤害并流血造成 200% 造成的伤害",
    "Effect: Smashs all enemies for 20 HP + 30% auto attack damage": "效果：粉碎所有敌人，造成 20 HP + 30% 自动攻击伤害",
    "Effect: Smashs enemy for 10 HP + 40% auto attack damage": "效果：粉碎敌人10HP+40%自动攻击伤害",
    "Effect: Stabs enemy for 20 HP + 70% auto attack damage": "效果：对敌人造成 20 生命值 + 70% 自动攻击伤害",
    "Gobo Slasher": "图案切割者",
    "Gobo Stabber": "图案刺杀者",
    "Foraging: Wheat": "觅食：小麦",
    "Cooking Speed": "烹饪速度",
    "Cooking Tool": "烹饪工具",
    "Cheese Smithing Tool": "奶酪加工工具",
    "Cheesesmithing Speed": "奶酪加工速度",
    "Enhancing Success": "增强成功率",
    "Enhancing Tool": "增强工具",
    "Foraging Speed": "觅食速度",
    "Foraging Tool": "觅食工具",
    "Type: Brewing Tool": "类型：冲泡工具",
    "Type: Cheese Smithing Tool": "类型：奶酪加工工具",
    "Type: Cooking Tool": "类型：烹饪工具",
    "Type: Enhancing Tool": "类型：增强工具",
    "Type: Feet": "类型：脚部",
    "Type: Hands": "类型：手部",
    "Type: Head": "类型：头部",
    "Type: Main Hand": "类型：主手",
    "Type: Off Hand": "类型：副手",
    "Verdant Boots": "翠绿长靴",
    "Verdant Brush": "翠绿画笔",
    "Verdant Buckler": "翠绿圆盾",
    "Verdant Bulwark": "翠绿壁垒",
    "Verdant Cheese": "青翠奶酪",
    "Verdant Cow": "青翠奶牛",
    "Verdant Enhancer": "翠绿增强剂",
    "Verdant Gauntlets": "翠绿护手",
    "Verdant Hammer": "翠绿之锤",
    "Verdant Helmet": "翠绿头盔",
    "Verdant Mace": "翠绿狼牙棒",
    "Verdant Plate Body": "翠绿板体",
    "Verdant Plate Legs": "翠绿板腿",
    "Verdant Pot": "青锅",
    "Verdant Shears": "翠绿剪刀",
    "Verdant Spatula": "翠绿抹刀",
    "Verdant Spear": "翠绿之矛",
    "Verdant Sword": "翠剑",
    "MACE PRIME": "梅斯总理",
    "Rainbow Boots": "彩虹靴",
    ...
    "Rainbow Bulwark": "彩虹壁垒",
    "Rainbow Cheese": "彩虹奶酪",
    "Rainbow Enhancer": "彩虹增强剂",
    "Rainbow Gauntlets": "彩虹护手",
    "Rainbow Hammer": "彩虹锤",
    "Rainbow Helmet": "彩虹头盔",
    "Rainbow Mace": "彩虹钉头锤",
    "Rainbow Plate Body": "彩虹板体",
    "Rainbow Plate Legs": "彩虹板腿",
    "Rainbow Pot": "彩虹锅",
    "Rainbow Shears": "彩虹剪",
    "Rainbow Spatula": "彩虹刮刀",
    "Rainbow Spear": "彩虹矛",
    "Rainbow Sword": "彩虹剑",
    "Cowscape": "奶牛景观",
    "Crimson Boots": "深红色靴子",
    ...
    "Crimson Bulwark": "深红壁垒",
    "Crimson Cheese": "深红色奶酪",
    "Crimson Cow": "深红牛",
    "Crimson Enhancer": "猩红强化剂",
    "Crimson Gauntlets": "深红护手",
    "Crimson Hammer": "深红之锤",
    "Crimson Helmet": "深红头盔",
    "Crimson Mace": "深红狼牙棒",
    "Crimson Plate Body": "深红板身",
    "Crimson Plate Legs": "深红板甲腿",
    "Crimson Pot": "深红锅",
    "Crimson Shears": "深红剪刀",
    "Crimson Spatula": "深红色抹刀",
    "Crimson Spear": "猩红之矛",
    "Crimson Sword": "绯红之剑",
    "Holy Boots": "神圣之靴",
    "Holy Brush": "神圣之刷",
    ...
    "Azure Bulwark": "蔚蓝壁垒",
    "Azure Cheese": "蔚蓝奶酪",
    "Azure Enhancer": "蔚蓝增强器",
    "Azure Gauntlets": "碧蓝护手",
    "Azure Hammer": "蔚蓝之锤",
    "Azure Helmet": "蔚蓝头盔",
    "Azure Mace": "蔚蓝狼牙棒",
    "Azure Plate Body": "蔚蓝板体",
    "Azure Plate Legs": "蔚蓝板甲腿",
    "Azure Pot": "蔚蓝锅",
    "Azure Shears": "蔚蓝剪刀",
    "Azure Spatula": "蔚蓝抹刀",
    "Azure Spear": "蔚蓝之矛",
    ...
    "Burble Brush": "泡泡刷",
    "Burble Buckler": "气泡圆环",
    "Burble Bulwark": "伯布尔壁垒",
    "Burble Cow": "泡泡奶牛",
    "Burble Enhancer": "气泡增强剂",
    "Burble Gauntlets": "泡泡手套",
    "Burble Hammer": "电锤",
    "Burble Helmet": "泡泡头盔",
    "Burble Mace": "伯布尔钉头锤",
    "Burble Plate Body": "气泡板体",
    "Burble Plate Legs": "气泡板腿",
    "Burble Pot": "泡泡锅",
    "Burble Shears": "泡泡剪刀",
    "Burble Spatula": "布尔刮刀",
    "Burble Spear": "泡泡长矛",
    ...
    "Cheese Buckler": "奶酪圆环",
    "Cheese Bulwark": "奶酪壁垒",
    "Cheese Enhancer": "奶酪增强剂",
    "Cheese Gauntlets": "奶酪护手",
    "Cheese Hammer": "奶酪锤",
    "Cheese Helmet": "奶酪头盔",
    "Cheese Mace": "奶酪棒",
    "Cheese Plate Body": "芝士盘体",
    "Cheese Plate Legs": "芝士盘腿",
    "Cheese Pot": "芝士锅",
    "Cheese Shears": "奶酪剪刀",
    "Cheese Spatula": "奶酪抹刀",
    "Cheese Spear": "奶酪矛",
    ...
    "Type: Legs": "类型：腿部",
    "Type: Milking Tool": "类型：挤奶工具",
    "Blackberry Cake": "黑莓蛋糕",
    "Blackberry Donut": "黑莓甜甜圈",
    "Burble Cheese": "气泡奶酪",
    "Cooldown(in combat)": "冷却时间（战斗中）",
    "Duration": "持续时间",
    "Cheesesmithing: Azure Cheese": "奶酪加工：蔚蓝奶酪",
    "If you are defeated in combat, your character will wait through a respawn timer before automatically continuing combat.": "如果您在战斗中被击败，您的角色将在自动继续战斗之前等待重生计时器。",
    "The success rate depends on your enhancing skill level, the tier of the equipment, and the equipment's current enhancement level. A successful enhancement will increase the level by 1 and failure will reset the level back to 0.": "成功率取决于你的强化技能等级、装备的等级以及装备当前的强化等级。 成功的增强会将等级提高 1，失败会将等级重置回 0。",
    "Type: Ability Book": "类型：能力书",
    "Type: Body": "类型：身体",
    "Type: Two Hand": "类型：双手",
    "Azure Milk": "蔚蓝牛奶",
    "Crimson Milk": "深红牛奶",
    "Type: Foraging Tool": "Type: Foraging Tool",
    "Remove": "移除",
    "Head": "头部",
    "Stab": "穿刺",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^([\d\.]+)e([\d\.,]+) elves$/, '$1e$2 精灵'],
    [/^([\d\.,]+)\/sec$/, '$1\/秒'],
    [/^([\d\.,]+) verdant cheese @$/, '$1 青翠芝士@'],
    [/^([\d\.,]+) Cheesesmithing$/, '$1 奶酪加工'],
    [/^([\d\.,]+) Brewing$/, '$1 冲泡'],
    [/^([\d\.,]+) Power$/, '$1 力量'],
    [/^([\d\.,]+) Enhancing$/, '$1 增强'],
    [/^([\d\.,]+) Foraging$/, '$1 觅食'],
    ...
    [/^([\d\.,]+) hour$/, '$1 小时'],
    [/^([\d\.,]+) Coins$/, '$1 金币'],
    [/^Requires: ([\d\.,]+) Power$/, '要求：$1 力量'],
    [/^Requires: ([\d\.,]+) Intelligence$/, '要求：$1 智力'],
    [/^Requires: ([\d\.,]+) Attack$/, '要求：$1 攻击'],
    [/^Requires: ([\d\.,]+) Cheesesmithing$/, '要求：$1 奶酪加工'],
    [/^Requires: ([\d\.,]+) Defense$/, '要求：$1 防御'],
    [/^Requires: ([\d\.,]+) Brewing$/, '要求：$1 冲泡'],
    [/^Requires: ([\d\.,]+) Cooking$/, '要求：$1 烹饪'],
    [/^Requires: ([\d\.,]+) Enhancing$/, '要求：$1 增强'],
    [/^HP Restore: (.+) HP over$/, '生命值恢复：$1 生命值以上'],
    [/^MP Cost: (.+) MP$/, '法力成本：$1 法力'],
    [/^Exp to Level Up: (.+)$/, '升级经验：$1'],
    [/^Total Level: (.+)$/, '总等级：$1'],
    [/^Total Experience: (.+)$/, '总经验：$1'],
    [/^HP Restore: (.+) HP$/, '生命值恢复：$1 恢复'],
    [/^Sell Price: (.+)$/, '出售价格：$1'],
    [/^Attack Level: (.+)$/, '攻击等级：$1'],
    [/^Defense Level: (.+)$/, '防御等级：$1'],
    [/^Intelligence Level: (.+)$/, '智力等级：$1'],
